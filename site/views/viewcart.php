                        ...
                        <form name="cart" id="cart" action="<?php echo $this->config->item('base_url');?>cart/updateproduct" method="post">
                        	...
                        	<div class="cart-wrapper">
                            	<div class="cart-table">
                            		<div class="cart-row headings" style="background-color:#ccc;">
										...
										<div class="cart-column"><strong>Edit</strong></div>
									</div>
                            		<!--cart-row ends-->
                            ...
                            <!--cart-wrapper ends-->
								...
								<ul class="submenu" id="demo<?php echo $items['rowid'];?>">
                                      <li>
                                      <table class="review-summary-responsive table-bordered" border="1">
                                          <tr>
			 ...
			 success: function(result)
				{
				   ...
				   if(result == '0'){ //Invalid						 
						 $("#errorcart").html('Invalid Gift Voucher.');
						 return false;
					 }else if(result == '1'){//free one time used
						  $("#errorcart").html('Your Gift Voucher is Alread Used.');						 
						 return false;
					 } else {
						window.location.reload();
					 }
