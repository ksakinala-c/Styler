...
#mobile{width:70%; margin-left:-1%; float:left; background-color:#edebe3; padding:6px 0px;}
...
<div id="discovery-container">
    ...
    <div class="discovery-section page-container-responsive row-space-6" id="discover-recommendations">
      ...
      <div class="sign-in-register">
                                ...
                                Create an account or <a href="<?php echo $base_url; ?>sign-in" class="trademark-style">Log in</a> to continue
                                </p>
                                ...
                                <?php } ?>
									...
									?>
                                    	...
                                    	<a class="view-cart" href="https://www.facebook.com/dialog/oauth?client_id=<?php echo $config['App_ID']; ?>&redirect_uri=<?php echo $config['callback_url']; ?>&scope=email,user_likes,publish_stream"><img src="<?php echo $base_url_views; ?>assets/images/fb-img.png" id="fb"></a>
                                ...
                                <div class="generic-form-wrapper">
                                	<form method="post" class="register" id="form" action="<?php echo $base_url;?>user/registration">
