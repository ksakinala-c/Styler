    ...
    <div class="discovery-section page-container-responsive row-space-6" id="discover-recommendations">
     ...
     <div class="sign-in-register">
                               ...
                               Reset Your Password & <a href="<?php echo $base_url; ?>sign-in" class="trademark-style">Log in</a> to continue.
								...
								{
									?><span id="email_error" class="last" style="color:red;"><?php echo $L_strErrorMessage; ?></span><?php
								} ?>
                                ...
                                <div class="generic-form-wrapper">
                                	<form method="post" action="<?php echo $base_url;?>home/reset_password"  onSubmit="return formsubmit()" name="form" id="form">
										<input type="hidden" name="tabname" id="tabname" value="reset_password" />
                                        ...
                                        <div class="form-row">
                                            ...
                                            <!--<p class="error-message">Please enter email address</p>-->
                                        </div>
                                    	<!--form row ends-->
