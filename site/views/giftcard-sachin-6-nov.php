...
<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12" style="margin-bottom:15px;">
                                        ...
                                        <select style="padding:8px 15px; margin:15px 0; border:1px solid #ccc; border-radius:8px;" class="selectpicker" data-style="btn-info">
                                        	<option>Slect Gift Voucher Theme</option>
                                            <option>Birthday Theme</option>
                                            <option>Anniversary Theme</option>
                                            <option>Special Occassion Theme</option>
                                            <option>Tailor Theme</option>
                                            <option>Corporate Gift Theme</option>                                                                                        
                                        </select>
                                        </div>
