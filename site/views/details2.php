...
<div class="arrow">
          ...
          <a href="#" id="left-arrow" style="float: left;">&lt;-</a> 
          
          <a href="#" id="right-arrow" style="float: right;">-></a> 
        </div> 
<img class="test_view" src="<?php echo $http_host;?>upload/products/<?php echo $productimages[0]->image; ?>" alt='' title="" />


<img class="test_view2" style="display: none" src="<?php echo $http_host;?>upload/products/<?php echo $productimages[1]->image; ?>" alt='' title="" />
					...
					<div id="right-col">
						...
						<div id="tabs">
							<ul class="nav nav-tabs nav-tab-cells fabric-tabs">
								<li class="active"><a data-toggle="tab" href="#tab-1">Fabric</a></li>
				...
				" itemprop="color"><table cellspacing="0" cellpadding="3" border="0" width="100%">
								...
								<div id="tab-2" class="tab-pane">
									...
									<div id="tab-3" class="tab-pane">
										<h3 class="shipping-txt-title">
										Free Shipping				</h3>
										<p class="shipping-smll-txt">
											We provide free shipping globally.</p>
										<h3 class="shipping-txt-title">Alterations &amp; Returns</h3>
