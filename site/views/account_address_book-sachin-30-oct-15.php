						...
						<form action="" method="post">
							<div class="step-chunk">
								...
								<div class="step-chunk">
                                   	<div class="account-address-wrap">
                                   		<div class="account-address-wrap-col">									<?php if($one_address != "") { ?>
                                            ...
                                            <p><a href="<?php echo $base_url; ?>account/edit_shipping_address/<?php echo $one_address->id; ?>">Edit Address</a></p>
								...
								<div class="step-chunk">
									...
									<p><a href="<?php echo $base_url; ?>account/add_shipping_address">Add new Shipping address</a></p>
								</div>
								<!--step-chunk ends-->
										...
										<div class="step-chunk">
                                        	<div class="account-address-wrap">
												...
												<div class="account-address-wrap-col">
                                                    ...
                                                    <p><a href="<?php echo $base_url; ?>account/edit_shipping_address/<?php echo $add->id; ?>">Edit Address</a></p>
