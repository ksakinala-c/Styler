...
#shouldertype5{display:block;padding:4px;border-radius:20px;background-color:#ccc;}
#shouldertype6{display:block;padding:4px;border-radius:20px;background-color:#ccc;}
#shouldertype7{display:block;padding:4px;border-radius:20px;background-color:#ccc;}
                            ...
                            <td align="center" valign="bottom">
                              <div class="">
                                <button type="submit" class="btn btn-primary btn-send-message-2b" style="margin:5px; 0px 0px 3px;">Next</button>	
								 <a href="<?php echo $base_url; ?>cart/bodymeasure/<?php echo $this->uri->segment(3); ?>" class="btn btn-primary btn-send-message-2b" style="margin:5px; 0px 0px 3px;">Back</a>
			                    </div></td>
                    </tr>                          
			</table></td>
			</tr>
