...
<table id="my-orders-table">
					...
					<?php 			
						...
						<tr>
							...
							<p><a href="<?php echo $base_url; ?>account/order_detail/<?php echo $order->order_id; ?>" class="copy-order">View Detail</a></p></td>
							...
							<td><p><span class="">Rs</span><?php echo $order->order_total; ?></p></td>
											...
											<?php	} else {
											?>
											<p><span class="WebRupee"></span><a href="javascript:void(0);" onclick="cancelorder(<?php echo $order->order_number; ?>); ">Cancel Order</a></p>
											<script>
						...
						<?php }} else { ?>
						<tr><td colspan="6"><p align="center">No Any Order Found.</p></td></tr>
					<?php } ?>
					</tbody>
				</table>
			</div>  
