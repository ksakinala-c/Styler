							...
							<div class="line egv-msg-popup fk-hidden" id="powermail_fieldwrap_331"  >
								<div class="line egv-msg-content">
									<div class="unit col-lg-12">
										<div class="line rw col-lg-6 col-md-6 col-sm-12 col-xs-12"> 
								...
								<div class="row">				                                
                                    ...
                                    <div class="col-lg-8 col-md-8 col-sm-8 col-xs6" id="selecttheme">
                                    	 
                                    </div>
                                    <div class="col-lg-4 col-md-4 col-sm-4 col-xs6">
								...
								<div>
									<div>CHOOSE YOUR GIFT CARD DESIGN.</div>
									<div style="width:100%;float:left;">
										<!--div id="selecttheme" style="width:70%;float:left;">&nbsp;</div-->
...
$(document).ready(function() {
	...
	$("#myaddcount").val(x+1);
		...
		if(x < max_fields){ 
            x++;  
		$(wrapper).append('<input type="hidden" value="'+x+'" class="myxvalue"/><ul id="egift-voucher-list" style="margin:0 auto;"><li><div class="line"><div class="fk-hidden fk-err-all unit size1of2" id="err-container_'+x+'" style="color:red"></div><div class="row"><div class="unit col-lg-6 col-md-6 col-sm-12 col-xs-12"><div class="line row"><div class="unit col-lg-4 col-md-5 col-sm-4 col-xs-12"><label for="recipient-email1">Receivers Email</label><span class="required">*</span></div><div class="lastUnit col-lg-8 col-md-9 col-sm-8 col-xs-12"><input type="text" name="recipientemail[]" id="recipientemail1'+x+'" placeholder="example123@mail.com" class="fk-input"></div></div><div class="line row"><div class="unit col-lg-4 col-md-5 col-sm-4 col-xs-12"><label for="confirm-recipient-email1">Re-type Email </label><span class="required">*</span></div><div class="lastUnit col-lg-8 col-md-9 col-sm-8 col-xs-12"><input type="text" id="confrimemail1'+x+'" autocomplete="off" placeholder="Confirm Email" class="fk-input"></div></div></div><div class="col-lg-6 col-md-6 col-sm-12 col-xs-12"><div class="lline row"><div class="unit col-lg-4 col-md-5 col-sm-4 col-xs-12"><label for="voucher-value1">Value of Gift Card(Rs)</label><?php /* <span class="required">*</span> */ ?></div><div class="lastUnit col-lg-8 col-md-9 col-sm-8 col-xs-12"><input type="text" name="value[]" id="value1'+x+'" onblur="getval1('+x+',this.id);" value="500" autocomplete="off" maxlength="5" class="fk-input egv-value"><select style="height:30px;" id="currency'+x+'" name="currency[]" class="currency-mobile-align"><option value="">Select Currency</option><?php if($allcurrency !=""){ foreach($allcurrency as $currency){ ?><option value="<?php echo $currency->id; ?>"><?php echo $currency->currency_code; ?></option><?php } } ?></select></div></div><div class="line row"><div class="unit col-lg-4 col-md-5 col-sm-4 col-xs-12"><label for="quantity1">Number of Gift Cards</label></div><div class="lastUnit col-lg-8 col-md-9 col-sm-8 col-xs-12"><input type="text" onblur="getval1('+x+',this.id);" name="qty[]" id="qty1'+x+'" value="1" autocomplete="off" maxlength="3" class="fk-input egv-quantity"></div></div></div></div><div class="line rw"><div class="unit size1of2"><input type="checkbox" value="0" onclick="mydivshow('+x+');" id="powermail_field_doruovaciaadresa2_11'+x+'" class="js-add-gift-msg"><label for="add-msg-checkbox1">&nbsp;Personalize your Gift Card</label></div><div class="lastUnit size1of2"><strong>Total Amount (Rs): <span id="total1'+x+'">500</span></strong></div></div><input type="hidden" value="500" name="totalpayable[]" id="totalpayable_'+x+'"/><div class="line egv-msg-popup fk-hidden" id="powermail_fieldwrap_'+x+'" ><div class="line egv-msg-content"><div class="unit col-lg-12"><div class="line rw col-lg-6 col-md-6 col-sm-12 col-xs-12"><div class="unit col-label"><label for="recipient-name1">To (Name) </label><span class="required">*</span></div><div class="lastUnit rt"><input type="text" maxlength="100" name="recipientname[]" id="recipientname'+x+'" placeholder="Receivers Name" class="fk-input"></div></div><div class="line rw col-lg-6 col-md-6 col-sm-12 col-xs-12"><div class="unit col-label"><label for="sender-name1">From (Name) </label><span class="required">*</span></div><div class="lastUnit rt"><input type="text" maxlength="100" name="sendername[]" id="sendername1'+x+'" placeholder="Senders Name" class="fk-input"></div></div></div></div><div class="row"><div class="col-lg-12" style="border-bottom: 1px solid #727272; margin-bottom:10px;"><br>ADD THEME</div><div id="selecttheme_'+x+'" class="col-lg-8 col-md-8 col-sm-8 col-xs6"></div><div class="col-lg-4 col-md-4 col-sm-4 col-xs6"><span style="width:100%;">Add Personal Message</span><textarea id="message1'+x+'" name="message[]" class="fk-input" maxlength="140" placeholder="Add a personalized message (in English) - Limit of 140 characters" for="chr-left"></textarea></div></div><div class="fk-hidden fk-err-all unit size1of2" id="err-container_'+x+'" style="color:red"></div><br><input type="hidden" value="'+x+'" class="myxvalue"/><div>	<div style="float: left; width: 100%; border-bottom: 1px solid #727272;"><br><div>CHOOSE YOUR GIFT CARD DESIGN.</div><div style="width:100%;float:left;"></div><?php if($giftcardtheme !="") { foreach($giftcardtheme as $pro){?><label><input onchange="gift_theme_view(this.value,'+x+');" type="radio" name="gift_theme_radio_'+x+'" id="gift_theme_radio_'+x+'" value="<?php echo $pro->image;?>"/><img width="200" height="100" src="<?php echo $front_base_url.'/upload/theme/medium/'.$pro->image?>"/></label><?php } } ?></div></div></div><a class="remove_field" style="float: right; top: 0px;" href="#" ><img width="20" src="<?php echo $base_url_views;?>images/closebutton.png"/></a></li></ul>');
