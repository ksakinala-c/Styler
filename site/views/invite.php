...
<div class="panel panel-dark">
  ...
  <div id="discovery-container">
	...
	<div class="inner-page-content" style="margin-top:1%;">
                      		<h1 class="page-title">Insider Dashboard</h1>
                            ...
                            <p>
                          	 ...
                          	 <div class="generic-form-wrapper" style="margin-top:-11%;">
                   	<form id="form1" class="form-horizontal form-groups-bordered" method="post" action="<?php echo $base_url."insider/invites/"; ?>" >
						<INPUT TYPE="hidden" NAME="hidPgRefRan" VALUE="<?php echo rand();?>">
						<INPUT TYPE="hidden" NAME="action" VALUE="inviters">
						 
                   		<h3 style="margin-top:7%;">Send Your Invitations With Multiple Email (Comma Seperate)</h3>
						...
						<div class="form-row">
						  <label for="Email">Email *</label>
							...
							<input name="email" type="text" class="text-field" id="Email" 
							value="" >
							</div>
                        ...
                        <div class="form-row">
                            <input type="submit" value="Invite" class="submit-button" >
                        </div>
                        <!--form-row ends-->
                    </form>
                </div>
