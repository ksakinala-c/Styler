...
#p3{display:block;}
				...
				<div class="nav-links">
					<div class="nav-previous">
						<a href="#" rel="prev">
							...
							<span class="post-title" style="color:#ee5e33;">Body Type</span>
						</a>
					</div><!-- /.nav-previous -->
					<div class="nav-next">
						<a href="#" rel="next">
  ...
  <tr>
                        <td height="50" colspan="3" align="center" valign="middle" bgcolor="#1ab7ea"><span style="color:#fff;" id="pos"><strong>Select Your Body Type</strong></span></td>
              </tr>
                      <tr>
					 ...
					 <tr>
						...
						<img onclick="document.getElementById('measure1').checked=true;" src="<?php echo $base_url_views; ?>images/broad.png" width="150" style="cursor:pointer;" >
						...
						<img onclick="document.getElementById('measure2').checked=true;" src="<?php echo $base_url_views; ?>images/column.png" width="150" style="cursor:pointer;" >
						...
						<img onclick="document.getElementById('measure3').checked=true;" src="<?php echo $base_url_views; ?>images/oval.png" width="150" style="cursor:pointer;" >
