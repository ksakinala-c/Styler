...
<div class="col-lg-6 col-md-6 col-sm-12 col-xs-12"> 
                                	<div class="line row">
										<div class="unit col-lg-4 col-md-5 col-sm-4 col-xs-12">
                                        	<label for="voucher-value1">Value of Gift Card</label><span class="required">*</span>
                                        </div>
<div class="lastUnit col-lg-8 col-md-9 col-sm-8 col-xs-12">
											<a href="javascript:void(0);" onclick="changecurrencyvalueminus('value');"><i class="fa fa-minus"></i></a>
											<input data="<?php echo $inc_default_val->incremental_val;?>" style="width:100px;" type="text" name="value[]" id="value" onblur="getval();" value="<?php echo $inc_default_val->default_value;?>" autocomplete="off" maxlength="5" class="fk-input egv-value">
                                             <a href="javascript:void(0);" onclick="changecurrencyvalueplus('value');"><i class="fa fa-plus"></i></a>
											<input type="hidden" id="statictotal" name="totalpayable[]" value="500">
											
                                            <select id="currency" name="currency[]" style="height:30px; width:150px;" class="currency-mobile-align" onchange="giftcarddefaultvalchg(this.value)">
                                                <?php foreach($allcurrency as $currency){ ?>
                                                <option value="<?php echo $currency->id; ?>" <?php if($inc_default_val->id==$currency->id){echo 'selected';}?>><?php echo $currency->currency_code; ?></option>
                                                <?php } ?>
                                            </select>
	<script>
		function changecurrencyvalueminus(value){
			var ogvalue = $("#"+value).val();
			var incremental = $("#"+value).attr('data');	
			
			if(ogvalue > 0) 
			{
				var incr = parseInt(ogvalue) - parseInt(incremental);
				if(incr<0){
					$("#"+value).val(ogvalue);
				}else{
				$("#"+value).val(incr);
		...
		function changecurrencyvalueplus(value){
			var ogvalue = $("#"+value).val();
			var incremental = $("#"+value).attr('data');	
		...
		function giftcarddefaultvalchg(cuurencyid){
			//alert(cuurencyid);
			var url = '<?php echo $base_url ?>home/giftcarddefaultvalchg/';
			$.ajax({
			url:url,
			type:'post',
			data:{'cuurencyid':cuurencyid},
			success:function(msg)
				{
					var ary = msg.split("@");
					//$("#value").val(ary[0]);
					$("#value").attr('value',ary[0]);
					$("#value").attr('data',ary[1]);							
					//alert(ary[1]);
					//document.getElementById('giftcontents').innerHTML = msg ;
				}
			});
...
<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12" style="margin-bottom:15px;">
                                            <div id="selecttheme" class="col-lg-7 col-md-7 col-sm-6 col-xs-12"><img width="200" height="100" src="<?php echo $front_base_url.'/upload/theme/medium/'.$giftcardtheme[0]->image?>"/></div>
                                        ...
                                        <select style="padding:8px 15px; margin:15px 0; border:1px solid #ccc; border-radius:8px;" class="selectpicker" data-style="btn-info" onchange="gift_theme_view1(this.value)">
                                        <?php foreach($giftcardtheme as $pro){ ?>
											<option value="<?php echo $pro->image;?>"><?php echo $pro->themename;?></option>
                                        <?php } ?>                
                                        </select>
                                        </div>
...
<div style="float: left; width: 100%; border-bottom: 1px solid #727272;"></div>
							...
							<div style="padding:0px;" class="input_fields_wrap"></div><br/>
                                    	...
                                    	<!--form row ends--> 
										  ...
										  <div class="lastUnit">
                                      	<input style="" type="button" id="add_field_button"  value="[+]  Add another Gift Card"  name="add_field_button"  class="btn btn-info" style="color:white">
                                    	<!--form row ends--> 
                                        </div>
<div style="" class="line"> 
                                            <div class="unit" style="width:100%; text-align:center; margin-top:25px;">
                                            	<label style="font:normal 20px Arial, Helvetica, sans-serif;" for="egv-message1">Amount Payable: </label>
                                            </div>
<div class="lastUnit"> 
...
<div id="checkbal" class="tab-pane">
					...
					<div class="line rw"> <div class="unit size1of2 lf"><label for="voucher-number">Gift Card Number </label><span class="required">*</span></div>
<div class="lastUnit size1of2 rt">
					
					<input type="text" name="gc_num" id="voucher-number" class="fk-input"></div> </div>
<div class="line rw"> <div class="unit size1of2 lf"><label for="voucher-pin">Gift Card PIN </label><span class="required">*</span></div>
<div class="lastUnit size1of2 rt">
					<input type="password" name="gc_pin" id="voucher-pin" class="fk-input"></div> </div>
<div class="line tpadding10"> <div class="lastUnit size1of2"><input type="button" onclick="checkgiftdetails(gc_num.value,gc_pin.value);" value="Get Details" class="btn btn-blue submit-button"></div> </div> </form>
					</div>
...
<div id="corporatereq" class="tab-pane">
						<div class="line"> 
                            ...
                            <form method="POST" id="corp-requirements-form"> 
                                <div class="line">
                                    <div class="unit col-xs-12">
                                        <div class="line rw">
                                        ...
                                        <input type="text" size="20" name="first_name" maxlength="40" class="fk-input" id="first_name">
                                        </div>
                                        </div>
                                    <div class="line rw">
                                    <div class="unit size1of3">
                                    ...
                                    <div class="lastUnit rt">
                                    <input type="text" size="20" name="last_name" maxlength="80" class="fk-input" id="last_name">
                                    </div>
                                    </div>
                                    <div class="line rw">
                                    <div class="unit size1of3">
                                    ...
                                    <div class="lastUnit rt">
                                    <input type="text" size="20" name="mobile" maxlength="40" class="fk-input" id="mobile">
                                    </div>
                                    </div>
                                    <div class="line rw">
                                    <div class="unit size1of3">
                                    ...
                                    <div class="lastUnit rt">
                                    <input type="text" size="20" name="email" placeholder="example123@mail.com" maxlength="40" class="fk-input" id="email">
                                    </div>
                                    </div>
                                    </div>
                                    <div class="col-xs-12">
                                    <div class="line rw">
                                    <div class="unit size1of3">
                                    <label for="estimated_value">Estimated Order Value:</label>
                                    </div>
                                    <div class="lastUnit rt">
                                    <select id="esitimated" title="Estimated Order Value" name="00N90000009wIgs">
                                    ...
                                    <div class="lastUnit rt">
                                    <select title="Location" name="00N9000000ANKVy" id="location">
                                    <option value="">--None--</option>
                                    ...
                                    <div class="line rw">
                                    <div class="unit size1of3">
                                    <label for="purpose_of_purpose">Purpose of Purchase</label>
                                    </div>
                                    <div class="lastUnit rt">
                                    <select id="purpose" title="Purpose of Purchase" name="00N90000009Thbk">
                                    <option value="">--None--</option>
                                    <option value="Channel RNR Program">Channel RNR Program</option>
                                    <option value="Employee RNR Program">Employee RNR Program</option>
                                    <option value="Seasonal Corporate Gifting">Seasonal Corporate Gifting</option>
                                    <option value="Corporate Consumption">Corporate Consumption</option>
                                    <option value="Sales Promotion Campaign">Sales Promotion Campaign</option>
                                    <option value="Personal">Personal</option>
                                    <option value="Reselling Purpose">Reselling Purpose</option>
                                    ...
                                    <div class="lastUnit rt">
                                    <input type="text" size="20" name="company" maxlength="40" class="fk-input" id="company">
                                    </div>
                                    </div>
                                    </div>
                                </div>
                            <div class="line">
                            <div class="lastUnit">
                            <button class="btn btn-orange submit-button btn-large" onclick="corporate_recruit()" type="button">Submit Details</button>
                            </div>
                            </div>
                            </form>
						</div>
