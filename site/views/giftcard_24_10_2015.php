...
$(document).ready(function() {
	...
	$("#myaddcount").val(x+1);
		...
		if(x < max_fields){ 
            x++;  
            $(wrapper).append('<div class="fk-hidden fk-err-all unit size1of2" id="err-container_'+x+'" style="color:red"></div><div style="float: left; width: 100%; border-bottom: 1px solid #727272;"><br><input type="hidden" value="'+x+'" class="myxvalue"/><ul id="egift-voucher-list" style="float: left; width: 100%;"><li><div class="line"><div class="unit size1of2"><div class="line rw"><div class="unit size1of3"><label for="recipient-email1">Receivers Email </label><span class="required">*</span></div><div class="lastUnit rt"><input type="text" name="recipientemail[]" id="recipientemail1'+x+'" placeholder="example123@mail.com" class="fk-input"></div></div><div class="line rw"><div class="unit size1of3"><label for="confirm-recipient-email1">Re-type Email </label><span class="required">*</span></div><div class="lastUnit rt"><input type="text" id="confrimemail1'+x+'" autocomplete="off" placeholder="Confirm Email" class="fk-input"></div></div></div><div class="lastUnit"><div class="line rw"><div class="unit size2of5"><label for="voucher-value1">Value of Gift Card(Rs) </label><span class="required">*</span></div><div class="lastUnit rt"><input type="text" name="value[]" id="value1'+x+'" onblur="getval1('+x+',this.id);" value="500" autocomplete="off" maxlength="5" class="fk-input egv-value"></div></div><div class="line rw"><div class="unit size2of5"><label for="quantity1">Number of Gift Cards</label> </div><div class="lastUnit rt"><input type="text" onblur="getval1('+x+',this.id);" name="qty[]" id="qty1'+x+'" value="1" autocomplete="off" maxlength="3" class="fk-input egv-quantity"></div></div></div></div><div class="line rw"><div class="unit size1of2"><input type="checkbox" value="0" onclick="mydivshow('+x+');" id="powermail_field_doruovaciaadresa2_11'+x+'" class="js-add-gift-msg"> <label for="add-msg-checkbox1">&nbsp;Personalize your Gift Card</label></div><div class="lastUnit size1of2"><strong>Total Amount (Rs): <span id="total1'+x+'">500</span></strong><input type="hidden" value="500" name="totalpayable[]" id="totalpayable_'+x+'"/></div></div><div class="line egv-msg-popup fk-hidden" id="powermail_fieldwrap_'+x+'" ><div class="line egv-msg-content"><div class="unit size1of2"><div class="line rw"><div class="unit col-label"><label for="recipient-name1">To (Name) </label><span class="required">*</span></div><div class="lastUnit rt"><input type="text" maxlength="100" name="recipientname[]" id="recipientname'+x+'" placeholder="Receivers Name" class="fk-input"></div></div><div class="line rw"><div class="unit col-label"><label for="sender-name1">From (Name) </label><span class="required">*</span></div><div class="lastUnit rt"><input type="text" maxlength="100" name="sendername[]" id="sendername1'+x+'" placeholder="Senders Name" class="fk-input"></div></div></div><div class="lastUnit size1of2"><div style="margin-top: 12px;" class="line"><div class="unit size1of5 tmargin5"><label for="egv-message1">Message: </label></div><div class="lastUnit"><textarea id="message1'+x+'" name="message[]" class="fk-input" maxlength="140" placeholder="Add a personalized message (in English) - Limit of 140 characters" for="chr-left"></textarea><span id="chr-left"></span></div></div></div></div></div></li></ul><a class="remove_field" style="float: right; top: 0px;" href="#" ><img width="20" src="<?php echo $base_url_views; ?>images/closebutton.png"/></a></div>');
        } else {
