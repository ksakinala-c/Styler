  ...
  <div id="discovery-container">
    ...
    <div class="discovery-section page-container-responsive row-space-6" id="discover-recommendations">
      ...
      <div class="sign-in-register">
                                <h1 class="page-title">Add Product Return </h1>
									<p style="color:green;"><?php echo $this->session->flashdata('msg'); ?></p>
                           
                                <div class="generic-form-wrapper">
                                <form class="form-horizontal form-groups-bordered" role="form" id="form" method="post" action="<?php echo $base_url;?>account/returnproducts/<?php echo $order_item_id; ?>" enctype="multipart/form-data" >
					...
					<INPUT TYPE="hidden" NAME="product_id" VALUE="<?php echo $product_id;?>">
										...
										<div class="form-row">
											...
											<div class="form-row">
												...
												<div class="text-field-wrap">
												<input type="text" name="order_item_name" id="order_item_name" value="<?php echo $order_item_name;?>" readonly class="text-field">
												</div>
											</div>
								...
								<option value="Unopened">Unopened</option>
											...
											<div class="form-row">
												...
												<div class="text-field-wrap">
												<input type="text" name="comment" id="comment" value="" class="text-field">
												</div>
											</div>
										...
										<?php if($allreturnaction != '' && count($allreturnaction) > 0)
												{ foreach($allreturnaction as $reasonact) { ?>
														<option value="<?php echo $reasonact->status; ?>"><?php echo $reasonact->status; ?></option>
												<?php  } }	 ?>
											</select>
											</div>
                                      ...
                                      <div class="form-row">
                                        <input class="submit-button linkified" name="login" type="submit" value="Submit" class="submit-button" onclick="javascript:validate(); return false;"> 
                                      </div>
                                   		<!--form-row ends-->
                                    </form>
                                </div>
