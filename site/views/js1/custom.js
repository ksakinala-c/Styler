...
function clearcanvas()
{
	...
	if(shirtjson.shirtstyle=="fullhands")
	{
		 ...
		 img101.src="images/"+shirtjson.fabid+"/shirt/front/sleeves_long_slim.png";
	...
	else if(shirtjson.shirtstyle=="halfhands")
	{
		$("#innercuffs").css("display", "none");
		 ...
		 img101.src="images/"+shirtjson.fabid+"/shirt/front/sleeves_short_slim.png";
  ...
  case "strightbottamstyle":
	 ...
	 if(shirtjson.innercontrast=="yes")
	 {
	  ...
	  var img101 = document.getElementById("inner_collar");
	   img101.src="images/innercontrast/"+shirtjson.innercontrastcolor+"/front/collar_stand_inner.png"
	   ...
	   if(shirtjson.innerplacketstat=="yes")
	  {
		...
		img101.src="images/innercontrast/"+shirtjson.innercontrastcolor+"/front/base_placket_inner_slim.png"
	   ...
	   if(shirtjson.innercuffstat=="yes")
	  {
		  ...
		  if(shirtjson.view=="front")
	      {
			  ...
			  if(shirtjson.cuffstyle=="angle")
	          {
				  ...
				  img101.src="images/innercontrast/"+shirtjson.innercontrastcolor+"/front/cuffs_angle_inner.png"
			  ...
			  else if(shirtjson.cuffstyle=="Bigangle")
			  {
	            ...
	            var img101 = document.getElementById("inner_bigangelcuff");
				 img101.src="images/innercontrast/"+shirtjson.innercontrastcolor+"/front/cuffs_big_angle_inner.png"
			  ...
			  else if(shirtjson.cuffstyle=="Biground")
	          {
			   ...
			   img101.src="images/innercontrast/"+shirtjson.innercontrastcolor+"/front/cuffs_big_round_inner.png"
			   ...
			   else if(shirtjson.cuffstyle=="French")
	          {
				...
				img101.src="images/innercontrast/"+shirtjson.innercontrastcolor+"/front/cuffs_french_inner.png"
			   ...
			   else if(shirtjson.cuffstyle=="Round")
	          {
				...
				img101.src="images/innercontrast/"+shirtjson.innercontrastcolor+"/front/cuffs_round_inner.png"
			   ...
			   else if(shirtjson.cuffstyle=="Square")
	          {
				...
				img101.src="images/innercontrast/"+shirtjson.innercontrastcolor+"/front/cuffs_square_inner.png"
...
function loadshirtpocket()
{
	...
	else if(shirtjson.shirtsidepocket=="yes")
	{
		...
		var img101 = document.getElementById("base_pocket");
		  document.getElementById("base_pocket").value="images/"+shirtjson.fabid+"/shirt/front/pocket_left_slim.png"
...
function drawcuffsfront()
{
	...
	if(shirtjson.cuffstyle=="angle")
	{
	 var img101 = document.getElementById("base_cuffs");
	  ...
	  img101.src="images/"+shirtjson.fabid+"/shirt/front/cuffs_angle_slim.png";
	  
	  if(shirtjson.outercontrast=="collarandcuff")
	 {
		 if(shirtjson.outercontrastcolor!="none")
		 {
			 img101.src="images/outercontrast/"+shirtjson.outercontrastcolor+"/front/cuffs_angle_slim.png"; 
		 }
	...
	else if(shirtjson.cuffstyle=="Bigangle")
	{
		 ...
		 img101.src="images/"+shirtjson.fabid+"/shirt/front/cuffs_big_angle_slim.png";
		 if(shirtjson.outercontrast=="collarandcuff")
	 {
		  if(shirtjson.outercontrastcolor!="none")
		 {
		 img101.src="images/outercontrast/"+shirtjson.outercontrastcolor+"/front/cuffs_big_angle_slim.png";
	     }
	 }
	}
	else if(shirtjson.cuffstyle=="Biground")
	{
		 var img101 = document.getElementById("base_cuffs2");
		  img101.src="images/"+shirtjson.fabid+"/shirt/front/cuffs_big_round_slim.png";
		   if(shirtjson.outercontrast=="collarandcuff")
	 {  
          if(shirtjson.outercontrastcolor!="none")
		 {
		 img101.src="images/outercontrast/"+shirtjson.outercontrastcolor+"/front/cuffs_big_round_slim.png";
		 }
	 }
	}
	else if(shirtjson.cuffstyle=="French")
	{
		 var img101 = document.getElementById("base_cuffs3");
		   img101.src="images/"+shirtjson.fabid+"/shirt/front/cuffs_french.png";
		     if(shirtjson.outercontrast=="collarandcuff")
	 {
		 
		  if(shirtjson.outercontrastcolor!="none")
		 {
		 img101.src="images/outercontrast/"+shirtjson.outercontrastcolor+"/front/cuffs_french.png";
	     }
	 }
	}
	else if(shirtjson.cuffstyle=="Round")
	{
		 var img101 = document.getElementById("base_cuffs4");
		   img101.src="images/"+shirtjson.fabid+"/shirt/front/cuffs_round_slim.png";
		    if(shirtjson.outercontrast=="collarandcuff")
	 {
		 if(shirtjson.outercontrastcolor!="none")
		 {
		 img101.src="images/outercontrast/"+shirtjson.outercontrastcolor+"/front/cuffs_round_slim.png";
	     }
	 }
	}
	else if(shirtjson.cuffstyle=="Square")
	{
		 var img101 = document.getElementById("base_cuffs5");
		  img101.src="images/"+shirtjson.fabid+"/shirt/front/cuffs_square_slim.png";
		   if(shirtjson.outercontrast=="collarandcuff")
	 {  
          if(shirtjson.outercontrastcolor!="none")
		 {
		 img101.src="images/outercontrast/"+shirtjson.outercontrastcolor+"/front/cuffs_square_slim.png";
		 }
	 }
	}
	...
	if(shirtjson.cuffstyle=="angle")
	{
	 var img101 = document.getElementById("back_cuffs");
	  ...
	  img101.src="images/"+shirtjson.fabid+"/shirt/back/cuffs_angle_slim.png";
	}
	
	else if(shirtjson.cuffstyle=="Bigangle")
	{
		 var img101 = document.getElementById("back_cuffs1");
		  img101.src="images/"+shirtjson.fabid+"/shirt/back/cuffs_big_angle_slim.png";
	}
	else if(shirtjson.cuffstyle=="Biground")
	{
		 var img101 = document.getElementById("back_cuffs2");
		  img101.src="images/"+shirtjson.fabid+"/shirt/back/cuffs_big_round_slim.png";
	}
	else if(shirtjson.cuffstyle=="French")
	{
		 var img101 = document.getElementById("back_cuffs3");
		  img101.src="images/"+shirtjson.fabid+"/shirt/back/cuffs_french.png";
	}
	else if(shirtjson.cuffstyle=="Round")
	{
		 var img101 = document.getElementById("back_cuffs4");
		   img101.src="images/"+shirtjson.fabid+"/shirt/back/cuffs_round_slim.png";
	}
	else if(shirtjson.cuffstyle=="Square")
	{
		 var img101 = document.getElementById("back_cuffs5");
		  img101.src="images/"+shirtjson.fabid+"/shirt/back/cuffs_square_slim.png";
	}
	...
	{ 
	 ...
	 img101.src="images/"+shirtjson.fabid+"/shirt/front/base_slim.png";
	 
	}
	else if(shirtjson.splacket=="shirtplacket")
	{
		 var img101 = document.getElementById("base_placket");
		  img101.src="images/"+shirtjson.fabid+"/shirt/front/base_slim_box.png";
    ...
    ctx6.clearRect(0, 0, 700, 880);
		 ...
		 var img101 = document.getElementById("base_placket1");
		  img101.src="images/"+shirtjson.fabid+"/shirt/front/base_slim_conceal.png";
	}
	else if(shirtjson.splacket=="shirtplacket2")
	{
		 var img101 = document.getElementById("base_placket2");
		   img101.src="images/"+shirtjson.fabid+"/shirt/front/base_slim_french.png";
	}
	else if(shirtjson.splacket=="shirtplacket3")
	{
		 var img101 = document.getElementById("base_placket3");
		 img101.src="images/"+shirtjson.fabid+"/shirt/front/base_slim_narrow.png";
	}
   ...
   //shirt buttons function	
	...
	{ 
	 ...
	 img101.src="images/"+shirtjson.fabid+"/shirt/front/collar_regular.png";
	 if(shirtjson.outercontrast=="collarandcuff"||shirtjson.outercontrast=="collaronly")
	 { 
         if(shirtjson.outercontrastcolor!="none")
		 {
		 img101.src="images/outercontrast/"+shirtjson.outercontrastcolor+"/front/collar_regular.png";
		 }
	...
	else if(shirtjson.collarstyle=="Big_round")
	{
		 ...
		 img101.src="images/"+shirtjson.fabid+"/shirt/front/collar_big_round.png";
	  if(shirtjson.outercontrast=="collarandcuff"||shirtjson.outercontrast=="collaronly")
	 {
		  if(shirtjson.outercontrastcolor!="none")
		 {
		 img101.src="images/outercontrast/"+shirtjson.outercontrastcolor+"/front/collar_big_round.png";
		 }
	...
	else if(shirtjson.collarstyle=="cut_way")
	{
		 var img101 = document.getElementById("base_collar2");
		  img101.src="images/"+shirtjson.fabid+"/shirt/front/collar_cut_away.png";
     if(shirtjson.outercontrast=="collarandcuff"||shirtjson.outercontrast=="collaronly")
	 {
		  if(shirtjson.outercontrastcolor!="none")
		 {
		 img101.src="images/outercontrast/"+shirtjson.outercontrastcolor+"/front/collar_cut_away.png";
		 }
		...
		else if(shirtjson.collarstyle=="Double_button")
	{
		 var img101 = document.getElementById("base_collar3");
		   img101.src="images/"+shirtjson.fabid+"/shirt/front/collar_dual_button.png";
		   if(shirtjson.outercontrast=="collarandcuff"||shirtjson.outercontrast=="collaronly")
	 {
		  if(shirtjson.outercontrastcolor!="none")
		 {
		 img101.src="images/outercontrast/"+shirtjson.outercontrastcolor+"/front/collar_dual_button.png";
		 }
	...
	else if(shirtjson.collarstyle=="low_semi_wide")
	{
		 var img101 = document.getElementById("base_collar4");
		  img101.src="images/"+shirtjson.fabid+"/shirt/front/collar_low_semi_wide.png";
		   if(shirtjson.outercontrast=="collarandcuff"||shirtjson.outercontrast=="collaronly")
	 {
		  if(shirtjson.outercontrastcolor!="none")
		 {
		 img101.src="images/outercontrast/"+shirtjson.outercontrastcolor+"/front/collar_low_semi_wide.png";
		 }
	...
	else if(shirtjson.collarstyle=="short_button_down")
	{
		 var img101 = document.getElementById("base_collar5");
		  img101.src="images/"+shirtjson.fabid+"/shirt/front/collar_short_button_down.png";
		  if(shirtjson.outercontrast=="collarandcuff"||shirtjson.outercontrast=="collaronly")
	 {
		  if(shirtjson.outercontrastcolor!="none")
		 {
		 img101.src="images/outercontrast/"+shirtjson.outercontrastcolor+"/front/collar_short_button_down.png";
		 }
	 }
	}
	else if(shirtjson.collarstyle=="stand")
	{
		 var img101 = document.getElementById("base_collar6");
		   img101.src="images/"+shirtjson.fabid+"/shirt/front/collar_stand.png";
		   if(shirtjson.outercontrast=="collarandcuff"||shirtjson.outercontrast=="collaronly")
	 {  
      if(shirtjson.outercontrastcolor!="none")
		 {
		 img101.src="images/outercontrast/"+shirtjson.outercontrastcolor+"/front/collar_stand.png";
		 }
	 }
	}
	else if(shirtjson.collarstyle=="wide_spread")
	{
		 var img101 = document.getElementById("base_collar7");
		  img101.src="images/"+shirtjson.fabid+"/shirt/front/collar_wide_spread.png";
	 if(shirtjson.outercontrast=="collarandcuff"||shirtjson.outercontrast=="collaronly")
	 {  
       if(shirtjson.outercontrastcolor!="none")
		 {
		 img101.src="images/outercontrast/"+shirtjson.outercontrastcolor+"/front/collar_wide_spread.png";
		 }
	 }
	}
	...
	{ 
	 ...
	 img101.src="images/"+shirtjson.fabid+"/shirt/back/collar_big_round.png";
	  if(shirtjson.outercontrast=="collarandcuff"||shirtjson.outercontrast=="collaronly")
	 {
		 img101.src="images/outercontrast/"+shirtjson.outercontrastcolor+"/back/collar_big_round.png";
	...
	else if(shirtjson.collarstyle=="Big_round")
	{
		 ...
		 img101.src="images/"+shirtjson.fabid+"/shirt/back/collar_dual_button.png";
		  if(shirtjson.outercontrast=="collarandcuff"||shirtjson.outercontrast=="collaronly")
	 {
		 img101.src="images/outercontrast/"+shirtjson.outercontrastcolor+"/back/collar_dual_button.png";
	...
	else if(shirtjson.collarstyle=="cut_way")
	{
		 ...
		 img101.src="images/"+shirtjson.fabid+"/shirt/back/collar_low_semi_wide.png";
		   if(shirtjson.outercontrast=="collarandcuff"||shirtjson.outercontrast=="collaronly")
	 {
		 img101.src="images/outercontrast/"+shirtjson.outercontrastcolor+"/back/collar_low_semi_wide.png";
		...
		else if(shirtjson.collarstyle=="Double_button")
	{
		 ...
		 img101.src="images/"+shirtjson.fabid+"/shirt/back/collar_regular.png";
		 if(shirtjson.outercontrast=="collarandcuff"||shirtjson.outercontrast=="collaronly")
	 {
		 img101.src="images/outercontrast/"+shirtjson.outercontrastcolor+"/back/collar_regular.png";
	...
	else if(shirtjson.collarstyle=="low_semi_wide")
	{
		 ...
		 img101.src="images/"+shirtjson.fabid+"/shirt/back/collar_short_button_down.png";
		 if(shirtjson.outercontrast=="collarandcuff"||shirtjson.outercontrast=="collaronly")
	 {
		 img101.src="images/outercontrast/"+shirtjson.outercontrastcolor+"/back/collar_short_button_down.png";
	...
	else if(shirtjson.collarstyle=="short_button_down")
	{
		 ...
		 img101.src="images/"+shirtjson.fabid+"/shirt/back/collar_short_point.png";
		 if(shirtjson.outercontrast=="collarandcuff"||shirtjson.outercontrast=="collaronly")
	 {
		 img101.src="images/outercontrast/"+shirtjson.outercontrastcolor+"/back/collar_short_point.png";
	...
	else if(shirtjson.collarstyle=="stand")
	{
		 ...
		 img101.src="images/"+shirtjson.fabid+"/shirt/back/collar_stand.png";
		 if(shirtjson.outercontrast=="collarandcuff"||shirtjson.outercontrast=="collaronly")
	 {
		 img101.src="images/outercontrast/"+shirtjson.outercontrastcolor+"/back/collar_stand.png";
	...
	{
		 var img101 = document.getElementById("back_collar6");
		 img101.src="images/"+shirtjson.fabid+"/shirt/back/collar_wide_spread.png";
		 if(shirtjson.outercontrast=="collarandcuff"||shirtjson.outercontrast=="collaronly")
	 {
		 img101.src="images/outercontrast/"+shirtjson.outercontrastcolor+"/back/collar_wide_spread.png";
...
function drawImage()
{
    ...
    
    {
	  ...
	  img101.src="images/"+shirtjson.fabid+"/shirt/back/base_slim.png";
	...
	var img101 = document.getElementById("back_side");
	  ...
	  img101.src="images/"+shirtjson.fabid+"/shirt/back/pleats_side_slim.png";
		//alert(img101.src);
    ctx10.drawImage(img101,49,0, 300, 400);
		break;
	...
	var img101 = document.getElementById("back_box");
	 img101.src="images/"+shirtjson.fabid+"/shirt/back/pleats_box_slim.png";
		//alert(img101.src);
    ctx10.drawImage(img101,49,0, 300, 400);
		break;
	...
	var img101 = document.getElementById("back_dart");
	 img101.src="images/"+shirtjson.fabid+"/shirt/back/pleats_dart_slim.png";
	 	//alert(img101.src);
    ctx10.drawImage(img101,49,0, 300, 400);
	  ...
	  if(shirtjson.shirtstyle=="fullhands")
	  {
		...
		var mycanvas2 = document.getElementById("canvas6");
		 ...
		 img101.src="images/"+shirtjson.fabid+"/shirt/back/sleeves_long_slim.png"
	  ...
	  else if(shirtjson.shirtstyle=="halfhands")
	  {
	    ...
	    ctx6.clearRect(0, 0, 700, 900);
		 ...
		 var img101 = document.getElementById("back_halfhands");
           img101.src="images/"+shirtjson.fabid+"/shirt/back/sleeves_short_slim.png"
		  ctx10.drawImage(img101,49,0, 300, 400);
...
function ftdrawImage()
{
	...
	img101.src="images/"+Trjson.fabid+"/Trouser/Front/BaseFront.png";
	 ...
	 switch(Trjson.beltstyle)
    {
	   ...
	   img101.src="images/"+Trjson.fabid+"/Trouser/Front/FrontBeltLoopSlim.png";
	    ctx10.drawImage(img101,59,320, 360, 420);
		 ...
		 var img101 = document.getElementById("trouser_belt1");
		  img101.src="images/"+Trjson.fabid+"/Trouser/Front/FrontBeltLoopThick.png";
	  ...
	  switch(Trjson.pleatstyle)
    {
	   ...
	   var img101 = document.getElementById("trouser_pleat");
	    img101.src="images/"+Trjson.fabid+"/Trouser/Front/FrontSinglePleat.png";
	   //alert(img101.src);
	   ctx10.drawImage(img101,59,320, 360, 420);
		 ...
		 var img101 = document.getElementById("trouser_pleat1");
		  img101.src="images/"+Trjson.fabid+"/Trouser/Front/FrontDoublePleat.png";
		   // alert(img101.src);
		 ctx10.drawImage(img101,59,320, 360, 420);
		 break;
		  case "nopleat":
    ...
    ctx6.clearRect(0, 0, 700, 880);
	    ...
	    img101.src="images/"+Trjson.fabid+"/Trouser/Front/FrontSlantPcoket.png";
    ...
    ctx6.clearRect(0, 0, 700, 880);
         ...
         img101.src="images/"+Trjson.fabid+"/Trouser/Front/FrontStraightPocket.png";
		 ctx10.drawImage(img101,59,320, 360, 420);
		 break;
	...
	var img101 = document.getElementById("trouser_sidebtn");
	 img101.src="images/"+Trjson.fabid+"/Trouser/Front/FrontNoLoopSideTab.png";
...
function btdrawImage()
{
	...
	img101.src="images/"+Trjson.fabid+"/Trouser/Back/BaseBack.png";
	 ...
	 switch(Trjson.beltstyle)
    {
	   ...
	   img101.src="images/"+Trjson.fabid+"/Trouser/Back/SlimBeltLoop.png";
	   ...
	   img101.src="images/"+Trjson.fabid+"/Trouser/Back/ThickBeltLoop.png";
	...
	img101.src="images/"+Trjson.fabid+"/Trouser/Back/SingleDart.png";
    ...
    ctx10.drawImage(img101,20,305, 340, 420);
		 ...
		 img101.src="images/"+Trjson.fabid+"/Trouser/Back/DoubleDart.png";
	...
	var img101 = document.getElementById("trouser_back1dblbone");
	 img101.src="images/"+Trjson.fabid+"/Trouser/Back/Back1PocketDougleBone.png";
	   ctx10.drawImage(img101,20,305, 340, 420);
		 ...
		 var img101 = document.getElementById("trouser_back2dblbone");
		  img101.src="images/"+Trjson.fabid+"/Trouser/Back/Back2PocketDoubleBone.png";
        ...
        img101.src="images/"+Trjson.fabid+"/Trouser/Back/Back1PocketSingleBone.png";
	   ctx10.drawImage(img101,20,305, 340, 420);
  ...
  case "bpdb2":
		 ...
		 var img101 = document.getElementById("trouser_back2sngbone");
          img101.src="images/"+Trjson.fabid+"/Trouser/Back/Back2PocketSingleBone.png";
		   ctx10.drawImage(img101,20,305, 340, 420);
...
if(shirtjson.splacket == "shirtplacket")
{
	...
	var img101 = document.getElementById("base_bottamhigh");
	 document.getElementById("base_bottamhigh").value="images/"+shirtjson.fabid+"/shirt/front/base_slim_box_high.png";
 ...
 else if(shirtjson.splacket == "shirtplacket1")
  {
	...
	var img101 = document.getElementById("base_bottamhigh1");
	 document.getElementById("base_bottamhigh1").value="images/"+shirtjson.fabid+"/shirt/front/base_slim_conceal_high.png";
	...
	var img101 = document.getElementById("base_bottamhigh2");
	 document.getElementById("base_bottamhigh2").value="images/"+shirtjson.fabid+"/shirt/front/base_slim_french_high.png";
	...
	var img101 = document.getElementById("base_bottamhigh3");
     document.getElementById("base_bottamhigh3").value="images/"+shirtjson.fabid+"/shirt/front/base_slim_narrow_high.png";
...
function fdrawbottam()
{
	...
	var img101 = document.getElementById("base_bottammid");
     document.getElementById("base_bottammid").value="images/"+shirtjson.fabid+"/shirt/front/base_slim_box_mid.png";
 ...
 else if(shirtjson.splacket == "shirtplacket1")
  {
    ...
    document.getElementById("base_bottammid1").value="images/"+shirtjson.fabid+"/shirt/front/base_slim_conceal_mid.png";
   ...
   document.getElementById("base_bottammid2").value="images/"+shirtjson.fabid+"/shirt/front/base_slim_french_mid.png";
  ...
  document.getElementById("base_bottammid3").value="images/"+shirtjson.fabid+"/shirt/front/base_slim_narrow_mid.png";
...
function fdrawbottam2()
{
	...
	var img101 = document.getElementById("base_bottamstright");
      document.getElementById("base_bottamstright").value="images/"+shirtjson.fabid+"/shirt/front/base_slim_box_straight.png";
  ...
  document.getElementById("base_bottamstright1").value="images/"+shirtjson.fabid+"/shirt/front/base_slim_conceal_straight.png";
	...
	var img101 = document.getElementById("base_bottamstright2");
	 document.getElementById("base_bottamstright2").value="images/"+shirtjson.fabid+"/shirt/front/base_slim_french_straight.png";
	...
	var img101 = document.getElementById("base_bottamstright3");
	 document.getElementById("base_bottamstright3").value="images/"+shirtjson.fabid+"/shirt/front/base_slim_narrow_straight.png";
