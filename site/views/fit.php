...
<!-- /header --><main>
    ...
    <div class="category-content">
        ...
        <div class="category-grid-view">
	      ...
	      <div class="container">
            ...
            <br> <br>
	<!-- form action="<?php echo $base_url;?>cart/brand/<?php echo $this->uri->segment(3); ?>" class="cart ui-content" method="post" id="product_addtocart_form" name="product_addtocart_form" -->
  ...
  <tr>
					...
					?>
						...
						<p><label>
                              <input type="radio" name="fit" id="fit5" <?php if($mudata !="" && $mudata->fit  !="" && $mudata->fit  == "1") { echo "Checked"; } ?> <?php if ($mudata !="" && $mudata->fit  == "0"){ echo "Checked"; } ?> value="1" >
                              </label></p>
						...
						<p><label>
                              <input type="radio" name="fit" id="fit6" <?php if($mudata !="" && $mudata->fit  !="" && $mudata->fit  == "2") { echo "checked"; }  ?> value="2" >
                              </label></p>
						...
						<p><label>
                              <input type="radio" name="fit" id="fit7" <?php if($mudata !="" && $mudata->fit  !="" && $mudata->fit  == "3") { echo "checked"; } ?> value="3" >
                              </label></					
						</td>
              </tr>
				<tr>
                          ...
                          <table width="100%" align="center">
						   <?php
                            ...
                            <tr>
                              ...
                              <input type="radio" name="fit" id="fit1" <?php if($mudata !="" && $mudata->fit  !="" && $mudata->fit  == "1") { echo "Checked"; } ?> <?php if ($mudata == "" OR $mudata->fit =="0"){ echo "Checked"; } ?> value="1" >
                              </label></td>
                              <td width="30%" align="center" valign="middle"><label>
						...
						<tr>
							<td align="center" valign="bottom">
							  <div class="form-actions">
								<a href="<?php echo $base_url; ?>cart/shoulderangle/<?php echo $this->uri->segment(3); ?>" class="btn btn-info btn-send-message-2b" style="margin:5px; 0px 0px 3px;">Back</a>
