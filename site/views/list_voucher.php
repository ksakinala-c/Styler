...
<div class="row">
<div class="col-xs-12 col-sm-12"><h6 class="main-title">List Gift Voucher  <a href="<?php echo $base_url; ?>coupan/download" style="float:right;color:white;" >Download</a></h6></div>
      ...
      <div class="end">
        <form action="<?php echo $base_url."coupan/lists_voucher";?>" method="post" enctype="multipart/form-data" id="form1"  class="pro"  autocomplete="on">
          <div class="form-group mock">
            ...
            <div class="col-lg-3">
				<input type="text" id="vouchername" name="vouchername"  value="<?php echo $vouchername; ?>" class="form-control jobtext from-dainn"   />
            </div>
