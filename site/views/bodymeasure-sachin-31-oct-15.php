...
#for{width:60%;float:left;margin-left:45%;margin-top:0%;}
...
#navl{width:20%;float:left;margin-left:-5%;}
#blue{width:75%;float:left;margin-left:10%;}
#for{width:60%;float:left;margin-left:30%;margin-top:-50%;}
        ...
        <div class="category-grid-view">
	      ...
	      <div class="container">
		    <ul class="breadcrumb pull-left">
				<li style="font-size:25px;">Shirt Measurement</li>
			</ul>
             <br> <br>
								  ...
								  <table width="100%" align="center">
									 <tr>
											...
											<td align="center" valign="bottom"  style="text-align:center;width:100%;">
												...
												<input name="bodypartvalue[]" type="text" onkeypress="return numbersonly(event)" required id="shirtmeaure_<?php echo $i; ?>" size="20" style="background-color:#fff;">
											</label>
