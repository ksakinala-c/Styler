                  ...
                  <td width="2%" align="center">&nbsp;</td>
                    ...
                    <!-- table width="100%" border="0" --> 
        				...
        				<div class="clear"></div>
                            ...
                            <div class="btn btn-primary btn-send-message-1" style="margin-top:2%;">
                            	<a onClick="javascript:subfilters();" href="javascript:void(0);" style="color:#fff;">PROCEED TO CART</a>
                            </div>
