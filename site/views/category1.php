...
<style>
    .feature-title1{font-size:16px;text-align:center;}
	#head {
    margin-left: 0px;
    margin-right: 0px;
    }
	...
	.brick-show{
	float:left;width:78%;padding-bottom:30px;padding-right:8px;padding-left:8px;
	}
   @media screen and (max-width:320px) {
	   #ck-button11 div table{width:auto !important;}
	    #ck-button12 div table{width:auto !important;}
	    #ck-button13 div table{width:auto !important;}
	   
   }
@media screen and (max-width:360px) {
	
	.brick{width:50%;float:left;text-align:center;padding:3px;}
...
{
	width:140px;height:180px;position:relative;
...
@media screen and (min-width: 768px) and (max-width: 1024px) {
    .brick-show{width:78%;text-align:center;padding:10px;} 
...
.brick
   ...
   /* @media screen and (min-width: 1025px) and (max-width: 1136px) {
        .brick-show{width:74%;text-align:center;} 
...
<?php if($subcatimage->banner == '') { ?>
 	...
 	<section class="category-header" <?php if($subcatimage->banner == '') {?>  style="background-image: url(<?php echo $http_host; ?>/site/views/images/category-banner.jpg)" <?php } ?> >
		<!-- div class="titalbarmainuss">
			<h1 class="category-title"><?php echo $subcatimage->scname; ?></h1>
 		</div -->
	</section>
...
<br/>
		...
		<div style="font-weight:bold;border-bottom:1px solid #CBD4D6;padding:10px 0px" id="clickme11">+ COLORS</div></td>
...
<div class="brick-show" style="">
			...
			<div class="brick" style="">
				...
				<div class="lazy-load">
				<img class="product_image" src="<?php echo $http_host;?>/upload/products/medium/<?php echo $images[$product->id][0]; ?>" name="Image21<?php echo $product->id; ?>" border="0" style="width:330px;" id="<?php echo $product->id; ?>"></a>			
				<div class="product_fimage patterns">
					<img   src="<?php echo $http_host;?>upload/products/medium/<?php echo $images[$product->id][1]; ?>" name="Image21<?php echo $product->id; ?>" border="0">
				...
				<h4 class="feature-title1" style="color:#3eabb8;"><b><?php echo $product->pname; ?></b></h4>
