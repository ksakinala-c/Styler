        ...
        <div class="category-grid-view">
	      ...
	      <div class="container">
		    <ul class="breadcrumb pull-left">
				<li style="font-size:25px;">Body Measurement</li>
			</ul>
            ...
            <main class="container inner-bottom-xs">
				...
				<p>
					<a href="<?php echo $base_url; ?>cart/measure">STANDARD SIZES</a> &nbsp;&nbsp; | &nbsp;&nbsp;  <a href="<?php echo $base_url; ?>home/measured">SHIRT MEASUREMENT</a>  &nbsp;&nbsp; | &nbsp;&nbsp;  <a href="<?php echo $base_url; ?>home/bmeasured" >BODY MEASUREMENT</a> &nbsp;&nbsp; | &nbsp;&nbsp;  <a href="<?php echo $base_url; ?>home/customerassist" >CUSTOMER ASSIST</a>
				</p>
								...
								<tr>
								  ...
								  <table width="100%" align="center"  style="text-align:center;">
									...
									<?php if($i == 0) { ?>
									 ...
									 <td colspan="2" align="center" valign="top" style="width:100%;"><span style="font-size:13px;text-align:center;width:100%;">Enter Your <?php echo $sizedata[$i]->pname;?> &nbsp;Measurement (<span class="textinch"><?php if($this->session->userdata('defaultmeasurement') == '1') { ?> Cms <?php } else { ?> In <?php } ?></span>)</span></td>
									...
									<tr>
											...
											<div class="form-actions">
												...
												<?php if(count($sizedata)-1 != $i){ ?>
													<button  data-toggle="tab" href="#description<?php echo $i+1; ?>" type="button" class="btn btn-primary btn-send-message-2b" onclick="nextvalidate('<?php echo $i; ?>');">Next</button>
													<?php if($i > 0) { ?>
														<button  data-toggle="tab" href="#description<?php echo $i-1; ?>" type="button" class="btn btn-primary btn-send-message-2b" style="margin:5px; 0px 0px 3px;">Back</button>
													<?php } ?>
												<?php } else { ?>
													<button type="submit" onclick="javascript:validate(); return false;" class="btn btn-primary btn-send-message-2b" style="margin:5px; 0px 0px 3px;">Submit</button>
													<button  data-toggle="tab" href="#description<?php echo $i-1; ?>" type="button" class="btn btn-primary btn-send-message-2b" style="margin:5px; 0px 0px 3px;">Back</button>
