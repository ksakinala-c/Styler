...
<div class="lastUnit col-lg-8 col-md-9 col-sm-8 col-xs-12">
											...
											<input style="width:100px;" type="text" name="value[]" id="value" onblur="getval();" value="500" autocomplete="off" maxlength="5" class="fk-input egv-value">
                                            ...
                                            <select id="currency" name="currency[]" style="height:30px; width:150px;" class="currency-mobile-align">
	...
	<script>
		function changecurrencyvalueminus(value){
			...
			if(ogvalue > 0) 
			{
				var incr = parseInt(ogvalue) - parseInt(100);
				$("#"+value).val(incr);
			}
		}	
