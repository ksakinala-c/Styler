...
#shouldertype5{display:block;padding:5px;border-radius:20px;background-color:#ccc;}
#shouldertype6{display:block;padding:5px;border-radius:20px;background-color:#ccc;}
#shouldertype7{display:block;padding:5px;border-radius:20px;background-color:#ccc;}
...
#shouldertype5{display:block;padding:4px;border-radius:20px;background:#ccc;width:10px;height:10px;}
#shouldertype6{display:block;padding:4px;border-radius:20px;background:#ccc;width:10px;height:10px;}
#shouldertype7{display:block;padding:4px;border-radius:20px;background:#ccc;width:10px;height:10px;}
...
display:block !important;
	  ...
	  #impheight{
	  background-color:#fff;border:0;width:60px;
	  }
	  #impweight{
	  background-color:#fff;width:50px;border:0;
	  }
        ...
        <div class="category-grid-view">
	      ...
	      <div class="container">
             <div class="skip-measurement">	
												...
												<tr><td>
												<button onclick="location.href='http://www.stylior.com/home/savemeasurement';" class="btn btn-info btn-send-message-2b" style="padding:0.3% 8% 0.3% 8%;font-size:18px;">BACK</button> 
											    </td><td align="right">
												<button onclick="location.href='http://www.stylior.com/cart/measure/';" class="btn btn-info btn-send-message-2b" style="padding:0.3% 8% 0.3% 8%;font-size:18px;">SKIP THIS STEP</button> 		
												</td>
												</tr></table>
												</div>
...
<form action="<?php echo $base_url;?>cart/measure/<?php echo $this->uri->segment(3); ?>" class="cart" method="post" id="product_addtocart_form" name="product_addtocart_form" >				  			
            <table width="100%" border="1">
              ...
              <?php /* <form action="<?php echo $base_url;?>cart/bodymeasure/<?php echo $style_id; ?>" class="cart" method="post" id="product_addtocart_form" name="product_addtocart_form" > */ ?>
                	...
                	<table id="table-height-weight" width="60%">
                      <tr>
					...
					<table class="table table-condensed" width="100%" style="margin-top:15px;">
					<?php
					...
					?>
						<tr>
							<td width="10%" height="40"  valign="middle" style="padding-top:20px;">HEIGHT</td>
							...
							<td align="right" valign="right" style="padding-top:20px;">
							<label>
						  ...
						  <tr>
							<td height="40" align="left" valign="middle" style="padding-top:10px;">WEIGHT </td>
							<td align="left" valign="middle"><label>
							  <input style="background-color:#fff;width:80%;" name="weight" type="text" id="weight" class="validate[required] wei lbs-conv-cls" onkeypress="return numbersonly(event)" maxlength="3"  <?php if($mudata !="" && $mudata->metricweight !="" && $mudata->metricweight > 0){ ?> value="<?php echo $mudata->metricweight;?>" <?php } ?>>KGS
							</label></td>
							<td  align="right" valign="right"><label>
