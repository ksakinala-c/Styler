...
.cart-calculation-row.buttons a.checkout {
    background: #F55A07 none repeat scroll 0 0;
    color:#fff;
}	
...
.cart-calculation-col .text-field {
    background: #fff none repeat scroll 0 0;    
    font-size: 14px;
    height:35px;
   }
   .update-cart-continue-wrap {
    border-bottom:none;
    padding: 0;
}
@media only screen and (max-width:768px){
	.cart-calculation-container,.cart-calculation-col,.cart-calculation-col.labels,.cart-calculation-col-amount,.cart-calculation-row,.cart-cal-disc-coupan-row,.cart-calculation-row.buttons a,.modal-dialog,.table-review-summary{width:100% !important;text-align:center;}
}
	@media only screen and (max-width:768px){
	.cart-calculation-row.buttons {width:100% !important;text-align:center;padding-left:20px;}
...
<div class="panel panel-dark">
  ...
  <div id="discovery-container">
    ...
    <div class="discovery-section page-container-responsive row-space-6" id="discover-recommendations">
	  ...
	  <?php if($_SESSION['profile-flash']!=''){?>
		  <div class="alert alert-success">      
			<?php echo $_SESSION['profile-flash']; $_SESSION['profile-flash']=''; ?>
		  </div>
		  <script>
  ...
  setTimeout(function(){ $('.alert-success').fadeOut() }, 5000);
	  ...
	  <?php //echo "<pre>";print_r($this->cart->_cart_contents); die;?>
		  <div style="display:block;margin-top:12px;">
                      		<div class="cart-page-title" style="display:inline-block;">CART (<?php echo $this->cart->total_items(); ?>) <!--<span class="cart-items">(3 items)</span>--></div>
		  </div>
                        	...
                        	<div class="cart-wrapper">
                            	<div class="cart-table">
                            		<div class="cart-row headings" style="background-color:#EDEDED;">
                                    	<div class="cart-column" style="vertical-align:middle">ITEM</div>
										<div class="cart-column" style="width:10%;vertical-align:middle">QTY</div>
										<div class="cart-column" style="vertical-align:middle">PRICE</div>
										<div class="cart-column"style="width:20%;vertical-align:middle">DELIVERY DETAILS</div>
										<div class="cart-column" style="vertical-align:middle">SUBTOTAL</div>										
										<div class="cart-column" style="text-align:center;vertical-align:middle">EDIT MEASUREMENTS</div>
									</div>
                            		<!--cart-row ends-->
                                    	...
                                    	<div class="cart-column">
                                       	  ...
                                       	  <div class="cart-pro-label-value-wrap"> 
												...
												<div class="cart-pro-value pro-name">
                                                          <a href="<?php echo $base_url;?>home/details/<?php echo $proditem->id; ?>/<?php echo $items['options']['prodid']; ?>"><img src="<?php echo $http_host;?>/upload/allstyle/small/<?php echo $proditem->image; ?>" width="10%"></a>
														  <a href="<?php echo $base_url;?>home/details/<?php echo $proditem->id; ?>/<?php echo $items['options']['prodid']; ?>"><?php echo $items['name']; ?></a>
 												</div>
												<?php } else { ?> 
												<div class="cart-pro-value pro-name">
                                                          <a href="javascript:void(0);"><img src="<?php echo $http_host;?>/upload/saveprofile/<?php echo $items['options']['imagename']; ?>" width="10%"></a>
                                            ...
                                            <!--cart-pro-label-value-wrap ends-->
                                              <div style="color:#D1D1D1;font-size:10px;"><img src="<?php echo $base_url;?>site/views/img/tick_fit.png" height="10" style="top:-2px;position:relative;" /> &nbsp; FIT GUARANTEE <span title="help">?</span></div>
								  <a style="float:right;width:100px;top:-150px;font-size:12px;cursor:pointer;" onClick="removeproduct('<?php echo $items['rowid'];?>', '<?php echo $items['id'];?>' );" >REMOVE</a>								   
								  <?php if($items['options']['is_3d'] != '2') {  ?>
                            		   <a type="" href="javascript:void(0)" class="" data-toggle="modal" data-target="#demo<?php echo $items['rowid'];?>">Review Summary    </a> 
<?php //if($items['options']['newmid'] != '') { ?>									   
									 <?php /*  <a href="<?php echo $base_url;?>cart/mapping/<?php echo $items['id']; ?>/<?php echo $items['options']['newmid']; ?>"> Edit </a> */ ?>
										 ...
										 <div class="cart-column unit">
                                        	<div class="cart-pro-label-value-wrap"> 
                                                ...
                                                <div class="cart-pro-label">
													...
													<div class="cart-pro-value" style="font-size:12px;">
													<?php 
													//echo date("Y-m-d");
                                          ...
                                          <div class="cart-column unit">
                                        	<div class="cart-pro-label-value-wrap"> 
                                                ...
                                                <div class="cart-pro-label">
                                                    ...
                                                    <!--"cart-pro-label ends-->
                                                <div class="cart-pro-value" style="width:100%;text-align:center">
                                                       <?php if($items['options']['newmid'] == '') { 
													    $cartDetails =  $this->cart_model->getcartDetails($items['id']);													  
													   ?> 
													   
													   <a href="<?php echo $base_url;?>cart/custommesurements/saved3d/<?php echo $items['options']['saveid']; ?>/<?php echo $cartDetails->id; ?>/">
													   <!---<img src="<?php echo $base_url;?>site/views/img/tape_measure.png" height="50" style="top:-2px;position:relative;" />---> Add your measurement
													   </a> <?php } else { ?> 
													  <a style="float:right;width:100px;" href="<?php echo $base_url;?>cart/mapping/<?php echo $items['id']; ?>/<?php echo $items['options']['newmid']; ?>"> 
													  " <?php echo $getprofilename =  $this->cart_model->getprofilename($items['options']['newmid']); ?> "<br/>
													   <img src="<?php echo $base_url;?>site/views/img/tape_measure.png" style="top:2px;position:relative;width:25%;height:25%;" />
													   </a>
													   <?php } ?> 
												 </div>
                                               </div>
        ...
        <button type="button" class="btn btn-default close" data-target="demo<?php echo $items['rowid'];?>" data-dismiss="modal">Close</button>
							...
							<?php $arr3d = json_decode($items['options']['details']); 
									 // print_r($arr3d);die;
									  ...
									  ?>
									<div id="demo<?php echo $items['rowid'];?>" class="modal fade close-modal-cls" role="dialog">
  <div class="modal-dialog">
    ...
    <div class="modal-content">
      ...
      <div class="modal-body table-responsive" style="padding:0% 2% 0% 2%;border:none;">
	  
									<div class="table-review-summary" style="float:left;position:relative;margin:auto;width:50%">
                                      <table class="table table-striped table-bordered table-hover table-condensed"  width="" border="1">
				...
				</div><div class="table-review-summary" style="display:inline-block;position:relative;margin:auto;width:50%;"><table class="table table-striped table-bordered table-hover table-condensed"  width="" border="1">
											<tr>
      ...
      <div class="modal-footer" style="padding:10px;">
        <button type="button" class="btn btn-default close" data-target="demo<?php echo $items['rowid'];?>" data-dismiss="modal">Close</button>
							...
							<div class="cart-calculation">
                                ...
                                <div class="cart-calculation-row" style="border:none;width:52%; float:right;padding-bottom:0px;">
								<script language="javascript">
...
$('.modal ').insertAfter($('body'));
								...
								<?php } ?>
                                	...
                                	<div class="cart-calculation-row" style="border:none;width:52%; float:right;">
                                    	<div class="cart-calculation-col labels" style="">
                                        	Subtotal
                                        
                                        </div>
                                        <!--cart-calculation-col labels ends-->
                                        
                                        <div class="cart-calculation-col" style="font-size:14px;" >
										   <strong>
													 			<?php
																if($this->session->userdata('currencycode') == 'INR')
																{ ?>
																		<span class="WebRupee">Rs.</span>  <?php echo $cart_subtotal;?> 
																<?php } else { 
																		echo $this->session->userdata('currencycode')." "; 
 																		echo $cart_subtotal;
																} ?>	
								  ...
								  <?php if($this->session->userdata('vouchercode') != '') { ?>
										 <div class="cart-calculation-row" style="border:none;width:52%; float:right;">
											...
											<div class="cart-calculation-col" style="">
												<strong>
													<?php if($this->session->userdata('currencycode') == 'INR') { ?>
													 <span class="WebRupee">Rs.</span> 
													 <?php } else { ?>  
                            ...
                            <div class="cart-calculation-row discount-col-cls">
									...
									<div class="cart-calculation-col"><strong>Have a Discount Code ?</strong></div>
                                    	<!--<div class="cart-calculation-col labels">
                                        	Amount Payable
										...
										<div class="cart-calculation-col-amount">
											<div class="cart-calculation-col labels" style="width:60%;text-align:center">
												<strong style="color:#A19894;font-size:16px;">Amount Payable</strong>
                                        
                                        </div>
											<!--<strong style="color:#A19894;">Amount Payable: </strong>
								...
								<div class="cart-cal-disc-buttons-wrap" style="width:100%;text-align:center;">
								<div class="cart-cal-disc-coupan-row" style="float:left;">	
											<div class="cart-calculation-col" style="width:230px;padding-left:20px;">
												  <div class="text-field-wrap">
														<input type="text" class="text-field" title="Enter Discount Code" name="voucher" id="voucher" >
												  </div>
											 </div>
									<br/><br/>
											
												<div class="cart-calculation-col" style="width:230px;text-align:center;">
													<input name="button" type="button" class="redeem-button" value="APPLY" onClick="vouchercode();">
												</div>
								</div>
								<div class="cart-cal-disc-coupan-row" style="float:right;">
									<div class="cart-calculation-row buttons">
                                    	<a href="<?php echo $base_url; ?>3dshirt">&lt; CONTINUE SHOPPING</a>                              
                                    
                                    </div>
                                    <!--continue shopping button  row ends-->
								 
									
									<div class="cart-calculation-row buttons">
                                    	<?php if($emptymeasurement == '1') { ?>
											<a href="javascript:void('0');" class="checkout" onClick="checkout();">PLACE ORDER</a>                       
										<?php } else { ?>
											<a href="javascript:void('0');" class="checkout" onClick="alert('Measurement for a design is not completed, please add the measurement.');">PLACE ORDER</a>  
										<?php } ?>
                                    </div>
