...
<table id="my-orders-table">
					...
					<tbody>
						...
						<tr>
							...
							<td><p><img src="<?php echo $http_host;?>/upload/allstyle/small/<?php echo $pro->image; ?>" width="50px" /></p></td>
							<td><p class="pending-delivery">
							 
							<a  class="btn btn-info" style="color:white" title="Delete" onclick="disapprove('<?php echo $base_url."account/delete_wishlist/"; ?><?php echo $pro->id; ?>');" href="javascript:void(0)" style="color:red" >Delete</a>
							</p></td>
