     ...
     <div class="category-content" style="margin-top:0px;">
		...
		<div class="row fadeInUp">
			...
			<div class="col-md-4a col-sm-4 feature">
				<div class="lazy-load"><a href="<?php echo $base_url; ?>home/details/<?php echo $product->proid; ?>/<?php echo $product->id; ?>" >
				<img src="<?php echo $http_host;?>/upload/allstyle/<?php echo $product->image; ?>" name="Image21<?php echo $product->id; ?>" width="300" height="290" border="0">
				</a></div>
				...
				<?php if($this->session->userdata('currencycode') == 'INR') { ?>
				  Rs <?php } else { echo $this->session->userdata('currencycode'); } ?> <?php  echo ($this->session->userdata('currencyvalue') * $product->sellingprice); ?>  
 				</h4>
			</div>
			<?php }} ?>
		</div>
