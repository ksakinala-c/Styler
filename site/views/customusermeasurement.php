...
<div class="category-content">
       ...
       <div class="category-grid-view">
            ...
            <div class="col-lg-12">
                <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12" style="margin-bottom:10px;"><button onclick="window.location.href = '<?php echo $base_url; ?>cart/mapping/<?php echo $productid; ?>'" class="btn btn-info btn-block">CREATE NEW PROFILE</button></div>
			<?php if($measureprofile != '' && count($measureprofile) > 0) { ?>	
