                                          ...
                                          <div class="cart-column unit">
                                        	<div class="cart-pro-label-value-wrap"> 
                                                ...
                                                <div class="cart-pro-value" style="width:100%;text-align:center">
													   ...
													   <img src="<?php echo $base_url;?>site/views/img/tape_measure.png" height="50" style="top:-2px;position:relative;" />
													   </a> <?php } else { ?> 
      ...
      <div class="modal-footer">
        <button type="button" class="btn btn-default close" data-target="demo<?php echo $items['rowid'];?>" data-dismiss="modal">Close</button>
							...
							<div class="cart-calculation">
                                ...
                                <div class="cart-calculation-row" style="border:none;width:70%; float:right;">
								<script language="javascript">
...
$('.close').on('click',function(){
  ...
  $('#'+trCls).removeClass("in");
								...
								<?php } ?>
                                	...
                                	<div class="cart-calculation-row" style="border:none;width:70%; float:right;">
                                    	<div class="cart-calculation-col labels" style="text-align:right;">
                                        	Subtotal
                                        
                                        </div>
                                        <!--cart-calculation-col labels ends-->
                                        
                                        <div class="cart-calculation-col" style="text-align:right;font-size:14px;" >
										   <strong>
													 			<?php
																if($this->session->userdata('currencycode') == 'INR')
																{ ?>
								  ...
								  <?php if($this->session->userdata('vouchercode') != '') { ?>
										 <div class="cart-calculation-row" style="border:none;width:70%; float:right;">
											...
											<div class="cart-calculation-col" style="text-align:right;">
												<strong>
													<?php if($this->session->userdata('currencycode') == 'INR') { ?>
													 <span class="WebRupee">Rs</span> 
													 <?php } else { ?>  
                            ...
                            <div class="cart-calculation-row discount-col-cls">
									...
									<div class="cart-calculation-col" style="float:left"><strong>Have a Discount Code ?</strong></div>
                                    	<!--<div class="cart-calculation-col labels">
                                        	Amount Payable
										...
										<div class="cart-calculation-col-amount" style="float:right;font-size:16px;"><strong style="color:#A19894;">Amount Payable: </strong>
								...
								<div class="cart-cal-disc-buttons-wrap" style="width:100%">
								<div style="float:left" style="width:48%">	
											<div class="cart-calculation-col" style="width:100%;margin: 0 30px; ">
												  <div class="text-field-wrap">
									...
									<br/><br/>
												...
												<div class="cart-calculation-col" style="width:100%;text-align:center;margin: 0 30px;">
													<input name="button" type="button" class="redeem-button" value="APPLY" onClick="vouchercode();">
												</div>
								</div>
								<div style="float:right" style="width:48%">
									
										<div class="cart-calculation-row buttons" style="float:left; background:red;">
                                    	<a href="<?php echo $base_url; ?>3dshirt" id="cart-btn" >&lt; CONTINUE SHOPPING</a>                              
                                    
                                    </div>
                                    <!--continue shopping button  row ends-->
								 <div class="cart-calculation-row buttons" style="float:right;">
