    ...
    <div class="col-md-2 col-sm-2">
		...
		<div class="col-md-10 col-sm-10">
			...
			<div class="post-thumbnail">
				...
				<select name="sizeid" id="sizeid" size="1" Onchange="checkdata(this.value);" >
					 <?php
                        ...
                        <td style="font-size:20px;" height="40" colspan="2" align="center" valign="middle">
                          <div class="">
                            ...
                            <button type="submit" class="btn btn-primary btn-send-message-2" style="margin:5px; 0px 0px 5px;" onclick ="return formsubmitcart();">Submit</button>	
							 	<a href="<?php echo $base_url; ?>cart/brand/<?php echo $mudata->pid; ?>" class="btn btn-primary btn-send-message-2" style="margin:5px; 0px 0px 5px;">Back</a>	
