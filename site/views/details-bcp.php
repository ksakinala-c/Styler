...
<style>
.magnifyarea {filter: progid:DXImageTransform.Microsoft.dropShadow(color=#818181, offX=5, offY=5, positive=true); background: white; width:570px !important;margin-top:0px !important; z-index:9999999999 !important; height:550px !important; float:left !important;}
.targetarea{width:500px; top:0px !important; height:394px !important;  border:1px solid #eee;}
.targetarea img {margin: auto; display: block; position: relative; border-width: 0; width:400px !important; top:0px !important;/* height:400px !important;*/}
.thumbs img {border:solid 1px #e5e5e5; width:97px; height:134px; padding:5px;}
.multizoom1.thumbs{margin:14px auto 0px; width:399px;}
.thumbs img:hover {border:solid 1px #00a7e8;}
...
#sav{margin-top:-55%;margin-left:-18%;}
@media only screen and (max-width : 480px){
#sav{margin-top:-45%;margin-left:5%;}
#tp{margin-top:85%;}
		...
		<div class="row single-product-row">
			<div class="col-sm-5 col-lg-5 gallery-holder">
				...
				<?php if($prodetails->image !="") { ?>
						<img id="multizoom1" alt="zoomable" title="" src="<?php echo $http_host;?>/upload/allstyle/<?php echo $prodetails->image; ?>"/>
				<?php } ?>				
								</div>
...
<div class="multizoom1 thumbs">
	...
	?>
	<a href="<?php echo $http_host;?>/upload/allstyle/large/<?php echo $styleimg->image; ?>" data-large="<?php echo $http_host;?>/upload/allstyle/large/<?php echo $styleimg->image; ?>" data-title=""><img src="<?php echo $http_host;?>/upload/allstyle/small/<?php echo $styleimg->image; ?>" alt="Milla" title=""/></a>
	<?php } } 
	...
	?>
	<a href="<?php echo $http_host;?>upload/products/large/<?php echo $styleimg->image; ?>" data-large="<?php echo $http_host;?>upload/products/large/<?php echo $styleimg->image; ?>" data-title=""><img src="<?php echo $http_host;?>upload/products/small/<?php echo $styleimg->image; ?>" alt="Milla" title=""/></a>
	<?php } } 
	?> 
</div>
						...
						<div class="tabs">
							...
							<div class="tab-content bewear-tab-content">
								<div id="description" class="tab-pane in active">
									<div class="text" id="sav"><?php echo $this->home_model->getstyledesc($prodetails->style_id); ?>
									<!--p >
