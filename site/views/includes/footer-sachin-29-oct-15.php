...
<!--footer popup starts-->    
<div id="mc-signup-sh" style="display: block;">
    <a href="javascript:void(0)" class="close-mail"><img src="<?php echo $base_url_views; ?>images/mail-arrow.jpg"></a> 
    <h3>Facing Issues ? Sorry about that!</h3>
</div>
<div id="mc_embed_signup" style="display: none;">
    <a href="javascript:void(0)" class="close-mail"><img src="<?php echo $base_url_views; ?>images/mail-arrow.jpg"></a>    
	<h3>Facing Issues ? Sorry about that!</h3>
    <h4 style="font-size:16px">We are in the process of upgrading our website, if you are facing any issues accessing some of our features kindly ContactUs and we'd be happy to help!</h4>
</div>    
<!--footer popup ends-->
