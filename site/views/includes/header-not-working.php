...
<link href="<?php echo $base_url_views; ?>assets/css/font-awesome.min.css" rel="stylesheet">
...
.navbar .navbar-nav > li > a {color:#FFFFFF; border:none; margin-bottom:11px;}
.navbar .navbar-header {background:none;}
.navbar-collapse {background: #051347 none repeat scroll 0 0;}
.cd-overlay {z-index:4;}
.navbar-toggle {float:left; margin:8px 0 8px 15px !important;}
.navbar-collapse.collapse.in {width:120%;}
.navbar .navbar-nav > li > a:hover, .navbar .navbar-nav > li > a:focus {color:white !important;}
.navbar-default .navbar-nav .open .dropdown-menu > li > a {color: white !important; padding-left: 45px !important;
}
@media only screen and (max-width:767px){
	#nav-mob-desk-align {top:60px !important;}
	.navbar .navbar-nav > li > a {padding:15px 23px !important;}
}
@media only screen and (min-width:768px){
	#nav-mob-desk-align {top:85px !important;}
}
...
#navbar .desktop-align-left {padding-left:0 !important;}
#navbar {padding-left:0 !important;}
#cd-primary-nav > li {width:90px !important;}
}
@media only screen and (max-width:360px){
	#ban, #how {margin-top: 15% !important;}
}
@media only screen and (min-width:361px) and (max-width:480px){
	#ban {margin-top: 13% !important;}
}
@media only screen and (min-width:481px) and (max-width:768px){
	#ban {margin-top: 5.2% !important;}
}
@media only screen and (min-width:769px){
	#ban {margin-top: 4.5% !important;}
}
</style>
	...
	$countrydata = getLocationInfoByIp();
		...
		if($currencycode == 'INR'){
			...
			$_SESSION['currencycode'] = 'INR';
					...
					$to = 'INR';
					$amount = '1';
					$cvalue = $this->footer->changecurrency($val); //$this->convertCurrency($amount, $from, $to); 
...
<header class="cd-main-header">
  <ul class="top-links">
    ...
    <li class="pull-right"><a href="#" class="country"><?php if($this->session->userdata('currencycode') == "EUR") { echo "EUR "; ?> <img src="<?php echo $base_url_views; ?>newheader/img/eur-flag.jpg" /> <?php  }?> 
...
<nav class="navbar navbar-default" id="nav-mob-desk-align" style="z-index:3; position:relative; width:90%;">
    <div class="container-fluid">
      ...
      <div id="navbar" class="navbar-collapse collapse">
        <ul class="nav navbar-nav">
          ...
          <li><a href="http://www.stylior.com/blog/" title="Our Blog">Blog</a></li>              
        </ul>
      </div><!--/.nav-collapse -->
    </div><!--/.container-fluid -->
</nav>
...
<!--nav class="cd-nav">
  <ul id="cd-primary-nav" class="cd-primary-nav is-fixed nav">
   <li><a class="desktop-align-left" href="http://www.stylior.com/3dshirt/" title="Custom Designs">Men's Shirt</a></li>
    <li class="dropdown">
      <a href="javascript:void(0);" data-toggle="dropdown" class="dropdown-toggle">More <b class="caret"></b></a>
      <ul class="dropdown-menu">
       <?php $getcmspanel = $this->footer->getcmspanel(); 
             if($getcmspanel != '' && count($getcmspanel) > 0) { 
             foreach($getcmspanel as $cms) {
				...
				<input type="hidden" name="<?php echo $i?>[rowid]" id="<?php echo $i?>[rowid]" value="<?php echo $items['rowid'];?>" />
				  <tr id="product_block" class="product_block_26636">
					...
					if($items['options']['is_3d'] == '0') { ?>
						...
						<td class="product_detail"><a href="<?php echo $base_url;?>home/details/<?php echo $proits->id; ?>"><span class="product-name"><?php echo $items['name']; ?></span></a><br> </td>
					...
					<td class="last_col"><span> <a onClick="removesproduct('<?php echo $items['rowid'];?>');" ><img title="Remove item" src="<?php echo $base_url_views; ?>newheader/img/close.png"></a> <br>
					  <span class="price_block"><span class="price"> <?php
																...
																<?php } else { 
																		...
																		echo $displayprice = roundUpToAny(( $items['price'] / ( $this->session->userdata('currencyvalue') * 0.9) ));
																} ?>   </span></span> </span></td>
				  </tr>
...
<input type="hidden" value="" id="typeofproducts" name="typeofproducts" />
	...
	<div class="homepagepopup" id="pop" style="display:none;padding:30px 0px 30px 0px">
 		<img src="<?php echo $base_url_views; ?>newheader/img/promo-x@2x.png" class="close-list">
 		<p style="color:#4aa4de;font-size:20px;text-align:center;"><strong>Lorem Ipsum is simply dummy text of the printing and typesetting industry !!</strong></p>
		<?php if($homepage->display == '1') { ?>
			<p>
			<span id="suberror" style="color:red;"></span>
			
			
			<form action="#" method="post" style="background-color:#4ca5df;width:48%;float:left;margin-top:5%;"> 
                                       	<!--view-account-details ends-->                                		
                                    	<div class="form-row" >
                                       	  <p style="text-align:center;font-size:14px;color:#fff;"><strong>Subscribe and get your bonus !!</strong><p>
                                       	  <div class="text-field-wrap">
                                        	<input name="textfield" type="text" class="text-field" id="fname" value="Name *" style="background-color:#066b93;border:none;border-radius:50px;color:#fff;text-align:center;margin-top:3%;">
                                          </div>
                                        ...
                                        <div class="form-row">
                                          	...
                                          	<div class="text-field-wrap">
                                        	<input name="textfield" type="text" class="text-field" id="emailsub" value="Email *" style="background-color:#066b93;border:none;border-radius:50px;color:#fff;text-align:center;margin-top:3%;">
                                            </div>
                                          	<!--text-field-wrap ends-->  
                                        </div>
                                    	<!--form row ends-->
										 ...
										 <div class="form-row">
                                          	...
                                          	<div class="text-field-wrap">
                                        	<input name="textfield" type="text" class="text-field" id="emailsub" value="Phone Number*" style="background-color:#066b93;border:none;border-radius:50px;color:#fff;text-align:center;margin-top:3%;">
                                            </div>
                                          	<!--text-field-wrap ends-->  
                                        </div>
                                    	<!--form row ends-->
                              ...
                              <div class="form-row">
                                        <input type="button" onClick="validatesub();" value="Subscribe to Stylior.com" id="sub" class="submit-button" style="background-color:#f7b800;border:none;border-radius:50px;color:#000;text-align:center;margin-top:3%;">
                                        
                                        <p style="text-align:center;font-size:12px;color:#fff;"><strong>Your information will never be shared<br>with any third party</strong><p>
                                      </div>
                                   		<!--form-row ends-->
											...
											<form action="#" method="post"  style="width:48%;float:left;margin-left:4%;margin-top:5%;"> 
                                       	<!--view-account-details ends-->                                		
                                    	<div class="form-row">
                                       	<img src="<?php echo $base_url_views; ?>images/dear.png">
										<p style="text-align:left;font-size:14px;color:#000;"><strong>
Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry</strong></p>
<li style="text-align:left;font-size:14px;color:#000;margin-left:3%">Lorem Ipsum is simply dumm</li>
<li style="text-align:left;font-size:14px;color:#000;margin-left:3%">Lorem Ipsum is simply dumm</li>
<li style="text-align:left;font-size:14px;color:#000;margin-left:3%">Lorem Ipsum is simply dumm</li>
<li style="text-align:left;font-size:14px;color:#000;margin-left:3%">Lorem Ipsum is simply dumm</li>
<li style="text-align:left;font-size:14px;color:#000;margin-left:3%">Lorem Ipsum is simply dumm</li>
