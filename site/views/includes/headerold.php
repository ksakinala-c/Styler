...
<?php /*?><link href="heder-css/css.css" rel="stylesheet" type="text/css"><?php */?>
<link rel="stylesheet" href="<?php echo $base_url_views; ?>heder-css/global.css">
<?php /*?><link rel="stylesheet" href="<?php echo $base_url_views; ?>heder-css/site.css">
<link rel="stylesheet" href="<?php echo $base_url_views; ?>heder-css/accountsection.css">
<link rel="stylesheet" href="<?php echo $base_url_views; ?>heder-css/globalV2.css"><?php */?>
...
<body>
<?php if($this->session->userdata('currencyvalue') =='')	
	{
...
<!-- div class="header__gms-wrapper default">
	<p style="text-align:center; color:#fff; line-height:39px;">ALL SALE 60% Off + Free shipping over $150. 
		<span>
			<a style="color:#fff;" class="legal promo-detail" href="#">See Details</a>
		</span>
	</p>
	...
	<div class="header__nav">
		<ul class="nav__utility left">
			...
			<li><a title="Lookbook" data-property="GLB_LOOKBOOK" href="#">Lookbook</a></li>
					...
					<li id="kids" class="kids">
						<a title="Jeans" href="#" data-property="GLB_AFKIDS">Jeans</a>
					</li>
				
		</ul>
		<a itemprop="url" href="<?php echo $base_url; ?>" title="Go to home page" class="logo white"><img src="<?php echo $base_url_views; ?>images/foot-logo-img.png"></a>
...
<div id="minicart-contents-wrap" class="empty">
	<div id="minicart-contents" class="minicart">
		...
		<div class="cart-details">
					...
					<div class="totals-wrap">
						...
						<li style="display: inline-block;" id="util-language" class="nav__utility--language util-main first">
								<a class="util-main" data-property="GLB_LANGUAGE" title="Language" href="">
    ...
    <div class="genericESpot" data-espotname="LanguageSelectorEMS">
			<ul class="util-language">      
				...
				<li <?php if($this->session->userdata('currencycode') == "EUR") { echo "Selected"; } ?>>
					...
					<img src="<?php echo $base_url_views; ?>images/eur-flag-img.png" width="65" height="20"></a>                                                        
				</li>
				<li>
	...
	<div class="condensed">
		<a itemprop="url" href="<?php echo $base_url; ?>" title="Go to home page."></a>
	</div>
...
<ul class="main">
				...
				<li id="cat-12202" class="cat-12202 first current 168206">
					...
					<a id="division_12202" class="" title="Mens" href="<?php echo $base_url; ?>home/category/<?php echo $cat->id;?>"><?php echo $cat->cname; ?></a>
...
<p class="button">
<a class="button" href="#" title="Continue" data-property="GLB_CONTINUE">Continue</a>
</p>
</div>
