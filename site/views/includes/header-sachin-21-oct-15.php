...
<header class="cd-main-header">
  <ul class="top-links">
	<?php if($this->session->userdata('userid') == "") { ?>
		<li><a href="<?php echo $base_url; ?>sign-in" title="Sign in">Sign in</a></li>
		<li><a href="<?php echo $base_url; ?>insider-signin" title="Insider">Insider</a></li>
		<li><a href="<?php echo $base_url; ?>affiliate-registration" title="Affiliate">Affiliate</a></li>
	<?php } else { ?>
