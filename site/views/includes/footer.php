<script>
    ...
    var _refiral=_refiral||{};_refiral.apiKey='0e7c7d6c41c76b9ee6445ae01cc0181d';
...
<footer>
	<div class="footer-list foot">
	 ...
	 <div class="footer-list">
        ...
        <ul>
		<li><a href="<?php echo $base_url; ?>StyleLounge/history-of-bespoke-clothing/" target="_blank" title="Fabric Saga">History Of Bespoke </a></li>
		<li><a href="<?php echo $base_url; ?>StyleLounge/the-perfect-shirt/" target="_blank" title="The Perfect Shirt">The Perfect Shirt</a></li>
		<li><a href="<?php echo $base_url; ?>StyleLounge/secrets-of-a-bespoke-outfit/" target="_blank" title="Secrets Of A Bespoke Outfit">Secrets Of A Bespoke Outfit</a></li>
		<li><a href="<?php echo $base_url; ?>StyleLounge/the-stylior-fit-guide/" target="_blank" title="Fit Guide">Fit Guide</a></li>
		<li><a href="<?php echo $base_url; ?>StyleLounge/keep-calm-and-wear-a-tie/" target="_blank" title="Tie a Tie">Tie a Tie</a></li>
    ...
    <div class="footer-list">
        ...
        <ul>
			...
			<li><a href="http://www.stylior.com/StyleLounge/" title="Your Account">Blog</a></li>
