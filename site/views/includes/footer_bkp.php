...
<footer class="anf__footer group has-social-terms">
	...
	<div class="footer__email--social">
		...
		<div class="social_holder" style="margin-top:-7%;">
			<a href="#" title="facebook-share" target="_blank"><img src="http://stylior.com/store/site/views/images/fb-icon.png" width="40" height="40" /></a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
            <a href="#" title="you-tube" target="_blank"><img src="http://stylior.com/store/site/views/images/you-tube-icon.png" width="40" height="40" /></a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
			<a href="#" title="twitter" target="_blank"><img src="http://stylior.com/store/site/views/images/twitter-icon.png" width="40" height="40" /></a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
			<a href="#" title="pinterest" target="_blank"><img src="http://stylior.com/store/site/views/images/pin-icon.png" width="40" height="40" /></a>
		</div>
	...
	<div class="footer__links group">
		...
		<div class="accordion">
			<ul>
				...
				<li>
					<a data-property="GLB_HOLLISTER" href="<?php echo $base_url; ?>our-story" title="About" class="omniture-hollister-link" target="">Our Story</a>
				</li>
                <li>
					<a data-property="GLB_HOLLISTER" href="<?php echo $base_url; ?>contact-us" title="Contact-us" class="omniture-hollister-link" target="">Contact Us</a>
				</li>
			</ul>
			<ul>
				<li>
				...
				<li>
					<a href="<?php echo $base_url; ?>payment-policy" class="omniture-brandprotection-link" title="Payment Policy" data-property="GLB_BRANDPROTECTION">Payment Policy</a>
				</li>
				
				<li>
					<a href="<?php echo $base_url; ?>privacy-policy" data-property="GLB_CASTING" title="Privacy Plolicy" target="">Privacy Policy</a>
				</li>
				<li>
					<a href="<?php echo $base_url; ?>terms-conditions" class="" title="Terms & Conditions" data-property="GLB_CAREERS" target="">Terms And Conditions</a>
				</li>
				
					<li>
						<a href="<?php echo $base_url; ?>disclaimer" class="omniture-anfcares-link" title="Website Disclaimer" data-property="GLB_ANFCARES" target="">Website Disclaimer</a>
					</li>
				
				<li>
					<a href="<?php echo $base_url; ?>shipment-return-policy" class="omniture-diversity-link" title="Shipment Return Policy" data-property="GLB_DIVERSITY" target="">Shipment, Returns & Cancellations</a>
				</li>
