...
<header class="cd-main-header">
  ...
  <ul class="cd-header-buttons">
	  ...
	  <li><a class="cd-nav-trigger" style="float: left" href="#cd-primary-nav"><span></span></a></li>
	  </ul>
	  
	  <ul class="search" style="float: right">
	  <li><a class="cd-search-trigger" style="float: right" href="#cd-search"><span></span></a></li>
	  </ul>
