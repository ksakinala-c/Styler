...
fbq('init', '813889165406698');
fbq('track', "PageView");</script>
<noscript><img height="1" width="1" style="display:none"
src="https://www.facebook.com/tr?id=813889165406698&ev=PageView&noscript=1"
/></noscript>
...
echo "<title>Stylior Bespoke Fashion Store Online, Mens Shopping, Shirts, Formal Wear, Mens Pants, Trousers</title>
<meta name=\"description\" content=\"The biggest online shopping store for bespoke fashion. Everything comes with 100% fit guarantee and free delivery.Explore international designer fashion store, custom made shirts, pants, formal wear accessories and much more. Book an appointment to get Stylior @ your premises. Get insights of latest fashion trends and fabrics only on Stylior.com\"/>
<meta name=\"keywords\" content=\"Bespoke Fashion,shirts,Pants,Trousers,Fashion Online,Fashion Online Shopping,Fashion Shopping Online,Fashion Store Online,Men Formal Wear,Mens Fashion Online,Online Fashion,Online Fashion Shopping,Online Fashion Store,Online Men Fashion,Online Shopping Fashion,Stylior Fashion,Stylior Lookbook,Mens Shirts,Mens Pants,mens clothing,shirts for men,mens trousers\"/>
<meta name=\"robots\" content=\"index, follow\"/>
<meta name=\"author\" content=\"Stylior\">";

} else if($_SERVER['REQUEST_URI'] == "/mens-shirts"){

echo "<title>Bespoke Shirts | Men's Shirts | Custom Tailored Shirts Online | Shirts For Men</title>
<meta name=\"description\" content=\"Buy custom made formal shirts online. Stylior offers FREE home delivery, hassle free returns and FIT guarantee for all products. Check latest collection of finest fabrics and trends in formal shirts and shop for tailor made outfits exclusively available on Stylior.com\"/>
<meta name=\"keywords\" content=\"shirts,buy shirts online,mens shirts,mens shirts online,formal shirts for men,formal shirts,online shirts for men,buy shirts for men,white shirts for men,mens clothing,cotton shirts,stylior shirts,buy stylior shirts online,mens fashion,dress shirt,shirts for men,tailor made,custom made,men formal wear,tailored shirt's,stylior mens shirts\"/>
<meta name=\"robots\" content=\"index, follow\"/>
<meta name=\"author\" content=\"Stylior\">
";
...
<!-- CSS reset -->
<link rel="stylesheet" href="http://www.stylior.com/site/views/newheader/css/style.css">
...
<link href="http://www.stylior.com/site/views/assets/css/main.min.css" rel="stylesheet">
...
<?php /*<script src="//load.sumome.com/" data-sumo-site-id="2b5efae1c5cec63dc08c803ce6fb1c21e558d9aa993722e68009ab1f0c885781" async="async"></script> */?>
</head>
<body>
<?php
...
<header class="cd-main-header">
  <ul class="top-links">
	...
	<?php if($this->session->userdata('userid') == "") { ?>
		...
		<li class="pull-left hidden-xs hidden-sm hidden-md"><a href="<?php echo $base_url; ?>home/giftcard" title="Gift Cards">
	...
	<?php } else {
		...
		<li class="pull-left hidden-lg"><a href="<?php echo $base_url; ?>home/giftcard" title="Gift Cards">
			<span>Gift Cards</span></a>
		</li>
		<li class=" hidden-xs"><a href="<?php echo $base_url; ?>home/giftcard" title="Gift Cards">
			<i class="fa fa-gift fa-2x"></i> <span style="position:relative; top:-3px;">Gift Cards</span></a>
		</li>
  ...
  <span class="cd-logo"><a href="<?php echo $base_url; ?>" title="Stylior Fashion Store Online"><img src="<?php echo $base_url_views; ?>newheader/img/foot-logo-img.png" onClick="" alt="Stylior Fashion Store Online"></a>
   ...
   <ul class="cd-header-buttons" style="left:0px; position:absolute;">
    
    <li><a class="cd-nav-trigger" href="#cd-primary-nav"><span></span></a></li>
  </ul>
  <a class="hidden-lg cd-search-trigger" href="#cd-search" style="right:0px; position:absolute ; top:40px"><span></span></a>
   <ul class="visible-lg cd-header-buttons" >
...
<div class="cd-primary-nav is-fixed nav">
<ul class="top_menu_linkss" style="list-style-type: none;">
 <li><a class="desktop-align-left" href="http://www.stylior.com/mens-shirts" title="Custom Designs">Men's Shirt</a></li>
 <li class="slide">
      <a href="#">More <b class="caret"></b></a>
      <ul class="dd"> 
	           <li><a href="http://www.stylior.com/page/our-story" class="aw">Our Story</a></li>
                <li><a href="http://www.stylior.com/page/why-stylior" class="aw">Why Stylior</a></li>
                <li><a href="http://www.stylior.com/page/fit-gurantee" class="aw">Fit Guarantee</a></li> 
				<li><a href="http://www.stylior.com/book_appointment/stylior_at_your_premises" class="aw">Book an appointment</a></li>
      </ul>
    </li>
	<li><a href="http://www.stylior.com/StyleLounge/" target="_blank" title="Our Blog">BLOG</a></li>
	 <li class=" hidden-lg "><a href="<?php echo $base_url; ?>affiliate-registration" title="Affiliate">Affiliate</a></li>
		<li class="hidden-lg"><a href="<?php echo $base_url; ?>insider-signin" title="Insider">Insider</a></li>
        <li class="hidden-lg"><a href="<?php echo $base_url; ?>home/giftcard" title="Gift Cards">
		<i class="fa fa-gift fa-2x"></i><span>Gift Cards</span></a>
		</li>
...
<nav class="cd-nav">
  <ul id="cd-primary-nav" class="cd-primary-nav is-fixed nav">
   <li><a class="desktop-align-left" href="http://www.stylior.com/home/mensshirts" title="Custom Designs">Men's Shirt</a></li>
   <?php
