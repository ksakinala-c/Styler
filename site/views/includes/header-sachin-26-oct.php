...
.desktop-align-left {padding-left:0 !important;}
}
</style>
...
<header class="cd-main-header">
  <ul class="top-links">
	...
	<li class="pull-right"><a href="#" class="toggle-menu menu-right push-body cart-icon cart-click"><span>Bag</span><span class="cart-quantity"><?php echo $this->cart->total_items(); ?></span></a></li>
	...
	<?php if($this->session->userdata('userid') == "") { ?>
		<li class="pull-right"><a href="<?php echo $base_url; ?>sign-in" title="Sign in">Sign in</a></li>
        ...
        <!--<li class="pull-left"><a href="<?php echo $base_url; ?>home/giftcard" title="eGift Cards">eGift Cards</a></li>-->
		<li class="pull-left"><a href="<?php echo $base_url; ?>home/giftcard" title="Gift Cards">
	...
	<?php } else { ?>
		...
		<li class="pull-left"><a href="<?php echo $base_url; ?>insider-signin" title="Insider">Insider</a></li>
        <!--<li class="pull-left"><a href="<?php echo $base_url; ?>home/giftcard" title="eGift Cards">eGift Cards</a></li>-->
		<li class="pull-left"><a href="<?php echo $base_url; ?>home/giftcard" title="eGift Cards">
			<i class="fa fa-gift fa-2x"></i> <span style="position:relative; top:-3px;">eGift Cards</span></a>
		</li>
		<li class="pull-right"><a href="<?php echo $base_url;?>account" title="My Account">My Account</a></li>
		<li class="pull-right"><a href="<?php echo $base_url;?>home/logout" title="Logout">Logout</a></li>	
	<?php } ?>
