				...
				<input type="hidden" name="<?php echo $i?>[rowid]" id="<?php echo $i?>[rowid]" value="<?php echo $items['rowid'];?>" />
				  <tr id="product_block" class="product_block_26636">
					...
					if($items['options']['is_3d'] == '0') { ?>
						...
						<td><a href="<?php echo $base_url;?>home/details/<?php echo $proditem->id; ?>/<?php echo $items['options']['prodid']; ?>" title="" class="product-image"><img width="75" height="75" src="<?php echo $http_host;?>/upload/allstyle/small/<?php echo $proits->image; ?>" ></a></td>

						<td class="product_detail"><a href="<?php echo $base_url;?>home/details/<?php echo $proditem->id; ?>/<?php echo $items['options']['prodid']; ?>"><span class="product-name"><?php echo $items['name']; ?></span></a><br> </td>

					<?php } else { ?>
						<td><a href="javascript:void(0);" title="" class="product-image"><img width="75" height="75" src="<?php echo $http_host;?>/upload/saveprofile/<?php echo $items['options']['imagename']; ?>" ></a></td>

						<td class="product_detail"><a href="javascript:void(0);"><span class="product-name"><?php echo $items['name']; ?></span></a><br> </td>
					<?php } ?>
