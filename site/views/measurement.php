                    ...
                    <tr>
                        <td style="font-size:20px;" height="40" colspan="2" align="center" valign="middle">
                          <div class="">
							...
							ALTERNATELY - Choose Body Measurements

							 we value quality and perfection.
							 we know that every man is different.
							 which is why we recommend
							 'Full Body Measurements' for a perfect fit.
							 You only need to spend few minutes once 
							 And you can get an amazing outfit which is Cut To Fit Just You!
							</div>
							 	<a href="<?php echo $base_url; ?>cart/mapping/<?php //echo $mudata->pid; ?>" class="btn btn-info btn-send-message-2" style="margin:5px; 0px 0px 5px;">TAKE MY MEASUREMENTS</a>	
                            <button type="submit" class="btn btn-info btn-send-message-2" style="margin:5px; 0px 0px 5px;" onclick ="return formsubmitcart();">PROCEED TO CHECKOUT</button>	                                
