				...
				$data['L_strErrorMessage'] = $this->validation->error_string;
					...
					if($_FILES['image']['name'] != ''){
							...
							$tmp_name1 =  $_FILES['image']['tmp_name'];
					 		$rootpath1 =  $this->config->item('upload')."subcategory/";
							$logoname = $_FILES['image']['name'];
							move_uploaded_file( $tmp_name1 , $rootpath1.$logoname );
							
							$tmp_path = $this->config->item('upload')."subcategory/".$logoname;
							$image_thumb= $this->config->item('upload')."/subcategory/small/".$logoname; 
							...
							$tmp_path = $this->config->item('upload')."subcategory/".$logoname;
							$image_thumb= $this->config->item('upload')."/subcategory/medium/".$logoname; 
							$height=800;
							$width=800;
