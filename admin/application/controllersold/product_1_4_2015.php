	...
	function trackadd()
		...
		if($this->input->post('action') == 'trackadd') 
		{
			...
			{	
				...
				$colour = $this->product_model->getcolorname($prorderdetail[0]->colour);
				$size = $this->product_model->getsizename($prorderdetail[0]->size);
				//echo $colour;die();
				...
				<p>Dear Customer, </p>
			    <p>We would like to inform you that part of your ollobra.com order has been Packed from our warehouse. You will receive this part of your order Shortly . </p>
				...
				<table cellpadding="5" style="border-top:2px solid #000;width: 700px;text-align: center;">
					<tr><td colspan="4">
					  <h2 style="margin-bottom: 0 !important;text-align: left;">'.$orderdetail[0]->order_item_name.'</h2></td>
					</tr>
					...
					<tr>
						<td>'.$colour.'</td>
						<td>'.$size.''.$prorderdetail[0]->cup.'</td>
						<td>'.$orderdetail[0]->product_quantity.'</td>
						<td>'.$orderdetail[0]->product_item_price.'</td>
					</tr>
			...
			<table align="right">		
					...
					<tr><td>Amount to be paid:</td><td>'.$orderdetail[0]->product_item_price.'</td></tr>';
					
					if($uorderdetail[0]->shippingcost != "" && $uorderdetail[0]->shippingcost>0 ) {  
					$message .='<tr>
					<td>Shipping Charges:</td><td>'.$uorderdetail[0]->shippingcost.'</td>
					</tr>' ;
					}
					
					if($uorderdetail[0]->is_gift != "" && $uorderdetail[0]->is_gift>0 ) {  
					$message .='<tr>
					<td>Shipping Charges:</td><td>'.$uorderdetail[0]->is_gift.'</td>
					</tr>' ;
					}
					...
					<p align="left"> If you need any assistance or have any questions, feel free to contact us by using the web form at http://www.ollobra.com/home/page/21.</p>
				...
				$message = '<div style="width:700px; height:auto; margin:0 auto;"> 
				<p>Dear Customer, </p>
			    <p>We would like to inform you that part of your ollobra.com order has been Dsipached  from our warehouse. You will receive this part of your order Shortly . </p>
				...
				<table cellpadding="5" style="border-top:2px solid #000;width: 700px;text-align: center;">
					...
					<tr>
						...
						<td>'.$size.''.$prorderdetail[0]->cup.'</td>
						<td>'.$orderdetail[0]->product_quantity.'</td>
						<td>'.number_format($orderdetail[0]->product_item_price,'2','.','').'</td>
					</tr>
			...
			<table align="right">		
					...
					<p align="left">We will send you another email when the remaining items are Dsipached  from our warehouse.</p>
					<p align="left"> If you need any assistance or have any questions, feel free to contact us by using the web form at http://www.ollobra.com/home/page/21.</p>
				...
				$subject  = 'Order Status from ollobra.com';  
				$headers  = 'MIME-Version: 1.0' . "\r\n";
				$headers .= 'Content-type: text/html; charset=iso-8859-1' . "\r\n";
				$headers .= 'From: ollobra.com <avonbras@gmail.com>' . "\r\n" .
							'Reply-To: avonbras@gmail.com' . "\r\n" .
