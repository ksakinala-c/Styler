...
<script>
	$(document).ready(function($){
		$('#reset').click(function(){
			var base_url = '<?php echo $base_url.'image/lists'; ?>';
		...
		$(function() {
		$.ajax({
			url:'<?php echo $base_url; ?>image/ajaxlist_product',
			type:'POST',
			data:'',
...
{
?>
<a href="<?php echo $base_url;?>image/lists"></a>
<?php
}
?>
<?php if(isset($_POST))
{
	...
	{
	?>
	<a class="btn btn-primary add" href="<?php echo $base_url;?>image/add/"><i class="entypo-plus"></i>Add Product Image</a>
	<?php
	}
	else
	{
...
<div role="grid" class="dataTables_wrapper form-inline" id="table-2_wrapper">
 ...
 <div class="col-xs-12 col-sm-12"><h6 class="main-title">List product Image</h6></div>

    <div class="col-6 col-sm-12 col-lg-12 action">
      <div class="end">
        <form action="<?php echo $base_url."image/lists";?>" method="post" enctype="multipart/form-data" id="form1"  class="pro">
          
          
          <div class="form-group mock">
          	<label class="col-sm-1 control-label lavel" for="inpeutEmail">Image:</label>
            <div class="col-lg-3"> 
				<input type="text" id="pname" value="<?php echo $imagename; ?>" name="imagename" class="form-control jobtext"/>
			</div>
...
<div class="row">
  ...
  <div role="grid" class="dataTables_wrapper form-inline" id="table-2_wrapper">
    <form action="<?php echo $base_url."image/deletes";?>" method="post" enctype="multipart/form-data" id="form">
        ...
        <tbody role="alert" aria-live="polite" aria-relevant="all">
          ...
          <tr class="odd">
            ...
            <!--<td class=" "><?php echo $results['id']; ?></td>-->
                     ...
                     <td class=" "><?php echo $results['imagename'] ?></td>
                     <td class=" ">
                     <a class="btn btn-default btn-sm btn-icon icon-left" title="Edit" href="<?php echo $base_url."image/edit/"; ?><?php echo $results['id']; ?>">
          ...
          <?php
                  ...
                  ?>
          <tr>
            <td class="left" colspan="4" align="center"><?php echo 'No Product Image Found'; ?></td>
          </tr>
          <?php
                  }
                  ?>
