...
<script type="text/javascript">
	...
	$(document).ready(function($)
	{
		...
		$('#reset').click(function(){
			...
			var base_url = '<?php echo $base_url.'returnstatus/lists/'.$this->uri->segment(3) ?>';
		...
		$.ajax({
			url:'<?php echo $base_url; ?>returnstatus/ajaxlist_status',
			type:'POST',
			data:'',
...
<li class="active"><strong>Return Status</strong></li>
</ol>
<?php if(isset($_POST))
{
if(count($result)==0)
...
{
?>
<a class="btn btn-primary add" href="<?php echo $base_url;?>returnstatus/add/<?php echo $this->uri->segment(3); ?>"><i class="entypo-plus"></i>Add Status</a>
<?php
}
else
{
...
<div role="grid" class="dataTables_wrapper form-inline" id="table-2_wrapper">
 ...
 <div class="col-xs-12 col-sm-12"><h6 class="main-title">List Return Action Status</h6></div>
    ...
    <div class="col-6 col-sm-12 col-lg-12 action">
      <div class="end">
        <form action="<?php echo $base_url."returnstatus/lists/".$this->uri->segment(3); ?>" method="post" enctype="multipart/form-data" id="form1"  class="pro">
...
<?php }  ?>
  ...
  <div role="grid" class="dataTables_wrapper form-inline" id="table-2_wrapper">
    <form action="<?php echo $base_url."returnstatus/deletes/".$this->uri->segment(3)." ";?>" method="post" enctype="multipart/form-data" id="form">
      ...
      <table id="table-2" class="table table-bordered table-striped datatable dataTable" aria-describedby="table-2_info" style="float:left;">
        ...
        <tbody role="alert" aria-live="polite" aria-relevant="all">
          ...
          <tr class="odd">
			...
			<td class=" ">
				<a class="btn btn-default btn-sm btn-icon icon-left" title="Edit" href="<?php echo $base_url."returnstatus/edit/"; ?><?php echo $result[$i]->id; ?>">
