...
<script type="text/javascript">
	$(document).ready(function($){
		$('#reset').click(function(){
			var base_url = '<?php echo $base_url.'product_attribuet/lists'; ?>';
		...
		$(function() {
		$.ajax({
			url:'<?php echo $base_url; ?>product_attribute/ajaxlist_blog',
			type:'POST',
			data:'',
...
<li class="active"><strong>Product Attribute</strong></li>
</ol> 
<?php if(isset($_POST))
{
if(count($result)==0)
...
{
?>
<a href="<?php echo $base_url;?>product_attribute/lists"></a>
<?php
}
?>
<?php if(isset($_POST))
{
	...
	{
	?>
	<a class="btn btn-primary add" href="<?php echo $base_url;?>product_attribute/add/"><i class="entypo-plus"></i>Add Product Attribute</a>
	<?php
	}
	else
	{
...
<div role="grid" class="dataTables_wrapper form-inline" id="table-2_wrapper">
  <div class="row">
 <div class="col-xs-12 col-sm-12"><h6 class="main-title">List Product Attribute</h6></div>

    <div class="col-6 col-sm-12 col-lg-12 action">
      <div class="end">
        <form action="<?php echo $base_url."product_attribute/lists";?>" method="post" enctype="multipart/form-data" id="form1"  class="pro">
          <div class="form-group mock">
          <label class="col-sm-1 control-label lavel" for="inputEmail">Price :</label>
            <div class="col-lg-3"> 
			<input type="text" id="price" name="price"  value="<?php echo $price; ?>"  class="form-control jobtext"/>
			</div>
            <div class="col-lg-5">
              <div class="set1">
  ...
  <div role="grid" class="dataTables_wrapper form-inline" id="table-2_wrapper">
    <form action="<?php echo $base_url."product_attribute/deletes";?>" method="post" enctype="multipart/form-data" id="form">
        ...
        <thead>
          <tr role="row" class="bg">
            ...
            <!--<th class="sorting" role="columnheader" aria-controls="table-2" style="width: auto;">Id</th>-->
                  ...
                  <th class="sorting" role="columnheader" aria-controls="table-2" style="width: auto;">Quaity</th>
        ...
        <tbody role="alert" aria-live="polite" aria-relevant="all">
          ...
          <tr class="odd">
            ...
            <!--<td class=" "><?php echo $results['id']; ?></td>-->
                     ...
                     <td class=" "><?php echo $results['quanity'] ?>
						
					 </td>
				     <td class=" ">
                     <a class="btn btn-default btn-sm btn-icon icon-left" title="Edit" href="<?php echo $base_url."product_Attribute/edit/"; ?><?php echo $results['id']; ?>">
          ...
          <?php
                  ...
                  ?>
          <tr>
            <td class="left" colspan="4" align="center"><?php echo 'No Product Attribute Found'; ?></td>
          </tr>
          <?php
                  }
                  ?>
