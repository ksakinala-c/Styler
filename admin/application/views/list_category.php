...
<script type="text/javascript">
	$(document).ready(function($) {
		...
		$(function() {
		$.ajax({
			url:'<?php echo $base_url; ?>category/ajaxlist_category',
			type:'POST',
			data:'',
...
{
?>
<a href="<?php echo $base_url;?>category/lists"></a>
<?php
}
?>
...
<?php if(isset($_POST))
{
	...
	{
	?>
	<a class="btn btn-primary add" href="<?php echo $base_url;?>category/add/"><i class="entypo-plus"></i>Add Category</a>
	<?php
	}
	else
	{
        ...
        <tbody role="alert" aria-live="polite" aria-relevant="all">
          ...
          <tr class="odd">
            ...
            <!--<td class=" "><?php echo $results['id']; ?></td>-->
			 <td class=""><img src="<?php echo $front_base_url;?>upload/category/small/<?php echo $result[$i]->image;?>" height="30px" width="50px"/></td>
           <td class=""><?php echo $result[$i]->cname; ?></td>
			...
			<td class=" ">
				<a class="btn btn-default btn-sm btn-icon icon-left" title="Edit" href="<?php echo $base_url."category/edit/"; ?><?php echo $result[$i]->id; ?>">
