...
<div class="col-xs-12 col-sm-12">
  <ol class="breadcrumb bc-3">
		...
		<li class="active"><strong>Edit Status  <?php  $status; ?></strong></li>
  </ol>
  </div>
  </div>
 			...
 			<div class="panel-heading fill">
                ...
                <div class="col-6 col-sm-4 col-lg-9">
                    ...
                    <div class="col-6 col-sm-4 col-lg-2 firm">
                      <button class="btn btn-default" onclick="javascript:window.location.href='<?php echo $base_url;?>status/lists'">Cancel</button>
                      <button class="btn btn-scoend" type="submit" onclick="javascript:validate();return false;">Submit</button>
                      </div>
 				</div>
 			</div>
			<form class="form-horizontal form-groups-bordered" role="form" id="form" method="post" action="<?php echo $base_url."status/edit/".$id; ?>" enctype="multipart/form-data" >
