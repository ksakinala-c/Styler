...
<div class="col-xs-12 col-sm-12">
  <ol class="breadcrumb bc-3">
		...
		<li class="active"><strong>Edit Users </strong></li>
  </ol>
  </div>
  </div>
  ...
  <div class="row">
 	<div class="col-md-12">
 		<div class="panel panel-primary" data-collapsed="0">
			...
			<form class="form-horizontal form-groups-bordered" role="form" id="form" method="post" action="<?php echo $base_url."users/edit/".$id; ?>">
				...
				<div class="form-group">
						...
						<div class="col-sm-6">
									...
									<div class="radio">
                        <label>
                        <input type="radio" id="enabled" name="enabled"  value="1"  <?php if($enabled == '1'){ ?> checked ="checked" <?php } ?> >
                          ...
                          Active
                      			...
                      			<div class="radio">
                        <label>
                        <input type="radio" id="enabled" name="enabled"  value="0"  <?php if($enabled == '0'){ ?> checked ="checked" <?php } ?> > Inactive
