...
<script type="text/javascript">
	$(document).ready(function($){
		...
		$('#reset').click(function(){
			var base_url = '<?php echo $base_url.'courier/lists'; ?>';
		...
		$.ajax({
			url:'<?php echo $base_url; ?>courier/ajaxlist_state',
			type:'POST',
			data:'',
...
{
?>
<a  href="<?php echo $base_url;?>courier/lists"></a>
<?php
}
else
{
...
<a class="btn btn-primary add" href="<?php echo $base_url;?>courier/add"><i class="entypo-plus"></i>Add Courier</a>
...
<div role="grid" class="dataTables_wrapper form-inline" id="table-2_wrapper">
  <div class="row">
	<div class="col-xs-12 col-sm-12"><h6 class="main-title">List Courier</h6></div>
    <div class="col-6 col-sm-12 col-lg-12 action">
      <div class="end">									
        <form action="<?php echo $base_url."courier/lists/"; ?>" method="get" enctype="multipart/form-data" id="form1"  class="pro">
          <div class="form-group mock">
            <label class="col-lg-1 control-label lavel" for="inputEmail">Courier :</label>
            <div class="col-lg-3">
...
<div role="grid" class="dataTables_wrapper form-inline" id="table-2_wrapper">
   <form action="<?php echo $base_url."courier/deletes";?>" method="post" enctype="multipart/form-data" id="form">
	...
	<tbody role="alert" aria-live="polite" aria-relevant="all">
		...
		<tr class="odd">
			...
			<td class=" ">
				<a class="btn btn-default btn-sm btn-icon icon-left" title="Edit" href="<?php echo $base_url."courier/edit/"; ?><?php echo $result[$i]->id; ?>">
		...
		<?php
            ...
            ?>
            <tr>
                <td class="left" colspan="4" align="center"><?php echo 'No Courier Found'; ?></td>
            </tr>
            <?php
            }
            ?>
