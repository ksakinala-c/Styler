...
<script type="text/javascript">
	$(document).ready(function($) {
		...
		$('#reset').click(function(){
				var base_url = '<?php echo $base_url.'placements/lists'; ?>';
		...
		$(function() {
		$.ajax({
			url:'<?php echo $base_url; ?>placements/ajaxlist_placements',
			type:'POST',
			data:'',
...
<div class="main-content theme">
  <ol class="breadcrumb bc-3">
    ...
    <li class="active"><strong>Placement</strong></li>
  </ol>
<?php if(isset($_POST))
{
if(count($result)==0)
...
{
?>
<a href="<?php echo $base_url;?>placements/lists"></a>
<?php
}
?>
<a class="btn btn-third add" href="javascript:void('0');" onclick="deleteplacements();"><i class="entypo-plus"></i>Delete</a>
<?php if(isset($_POST))
{
	if(count($result)==0)
	{
	?>
	<a class="btn btn-primary add" href="<?php echo $base_url;?>placements/add/"><i class="entypo-plus"></i>Add Placements</a>
	<?php
	}
	else
	{
...
<div class="row">
<div class="col-xs-12 col-sm-12"><h6 class="main-title">List Placements</h6></div>
     <div class="col-6 col-sm-12 col-lg-12 action">
      <div class="end">
        <form action="<?php echo $base_url."placements/lists";?>" method="post" enctype="multipart/form-data" id="form1"  class="pro"  autocomplete="on">
          <div class="form-group mock">
            <label class="col-sm-1 control-label lavel" for="inputEmail">Placements :</label>
            <div class="col-lg-3">
           <input type="text" id="pname" name="pname"  value="<?php echo $pname; ?>" class="form-control jobtext from-dainn"   />
            </div>
			<div class="col-lg-5">
			<div class="set1">
...
<?php }  ?>
  ...
  <div role="grid" class="dataTables_wrapper form-inline" id="table-2_wrapper">
    <form action="<?php echo $base_url."placements/deletes";?>" method="post" enctype="multipart/form-data" id="form">
      ...
      <table id="table-2" class="table table-bordered table-striped datatable dataTable" aria-describedby="table-2_info" style="float:left;">
        <thead>
          <tr role="row" class="bg">
			...
			<th class="sorting" role="columnheader" aria-controls="table-2" style="width: auto;">Placements 	</th>
        ...
        <tbody role="alert" aria-live="polite" aria-relevant="all">
          ...
          <tr class="odd">
           ...
           <td class=""><?php echo $result[$i]->pname; ?></td>
			...
			<td class=" ">
				<a class="btn btn-default btn-sm btn-icon icon-left" title="Edit" href="<?php echo $base_url."placements/edit/"; ?><?php echo $result[$i]->id; ?>">
          ...
          <?php
                  ...
                  ?>
          <tr>
            <td class="left" colspan="4" align="center"><?php echo 'No placements Found.!!'; ?></td>
          </tr>
          <?php
                  }
                  ?>
