...
<script type="text/javascript">
	...
	$("#sbutton").click(function(){
		...
		$('#reset').click(function(){
				var base_url = '<?php echo $base_url.'giftcard/lists'; ?>';
...
<ol class="breadcrumb bc-3">
	...
	<li class="active"><strong>Giftcardtheme</strong></li>
</ol>
...
<a class="btn btn-primary add" href="<?php echo $base_url;?>giftcard/add"><i class="entypo-plus"></i>Add Giftcard Theme</a>
</div>
<div class="row"><br/></div>
<div class="row">
<div class=""><h6 class="main-title">List Theme Name</h6></div>
     <div class="">
      <div class="end">
        <form action="<?php echo $base_url."giftcard/lists";?>" method="post" enctype="multipart/form-data" id="form1"  class="pro"  autocomplete="on">
          <div class="form-group mock">
            <label class="col-sm-1 control-label lavel" for="inputEmail">Theme name :</label>
            <div class="col-lg-3">
...
<form action="<?php echo $base_url."giftcard/deletes/";?>" method="post" enctype="multipart/form-data" id="form">
...
<table id="table-2" class="table table-bordered table-striped datatable dataTable" aria-describedby="table-2_info">
	...
	<tbody role="alert" aria-live="polite" aria-relevant="all">
		...
		<tr class="odd">
			...
			<td class=""><img src="<?php echo $front_base_url;?>upload/theme/small/<?php echo $result[$i]->image;?>" /></td>
			<td class=" "><?php if($result[$i]->order !="" && $result[$i]->order >0){ echo $result[$i]->order; } else { echo "Not Updated"; } ?></td>
			<td class=" ">
				<a class="btn btn-default btn-sm btn-icon icon-left" title="Edit" href="<?php echo $base_url."giftcard/edit/"; ?><?php echo $result[$i]->id; ?>">
		...
		<?php
            ...
            ?>
            <tr>
                <td class="left" colspan="8" align="center"><?php echo 'No Giftcardtheme Found'; ?></td>
            </tr>
            <?php
            }
            ?>
