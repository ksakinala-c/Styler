  ...
  <div class="row">
 	<div class="col-md-12">
 		<div class="panel panel-primary" data-collapsed="0">
			...
			<form class="form-horizontal form-groups-bordered" role="form" id="form" method="post" action="<?php echo $base_url."parts/edit/".$id.'/'.$partid; ?>" enctype="multipart/form-data" w>
					<INPUT TYPE="hidden" NAME="hidPgRefRan" VALUE="<?php echo rand();?>">
					<INPUT TYPE="hidden" NAME="action" VALUE="edit_parts">
					<INPUT TYPE="hidden" NAME="tblid" VALUE="<?php echo $id;?>">
					<INPUT TYPE="hidden" NAME="subcatid" VALUE="<?php echo $partid;?>">
				...
				<div class="form-group">
					...
					<div class="col-sm-5">
					  <input type="checkbox" id="hide_in_size" name="hide_in_size" value="1" <?php if($hide_in_size=="1") { echo "Checked"; } ?> class="">
					</div>
			 				</div>
 				</div>
				</form>
