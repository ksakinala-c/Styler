...
<div class="main-content">
  <ol class="breadcrumb bc-3">
		...
		<li class="active"><strong>Add List View Product</strong></li>
  </ol>
 	...
 	<div class="col-md-12">
 		<div class="panel panel-primary" data-collapsed="0">
			...
			Add Banner
				...
				<form class="form-horizontal form-groups-bordered" role="form" id="form" name="form" method="post" action="<?php echo $base_url;?>hmlistpage/add" enctype="multipart/form-data">
				<div class="panel-body">
					<INPUT TYPE="hidden" NAME="hidPgRefRan" VALUE="<?php echo rand();?>">
					<INPUT TYPE="hidden" NAME="action" VALUE="add_hmlistpage">
					 ...
					 <div class="form-group">
					  ...
					  <div class="form-group">
					    ...
					    <div class="col-sm-5">
					      <input type="text" id="fabric_id" name="fabric_id" class="form-control">
					    </div>
					  </div>
<div class="form-group">
					    <label class="col-sm-2 control-label" for="slider_header">Fabric Name:</label>
					    <div class="col-sm-5">
					        <input type="text" id="fabric_name" name="fabric_name" class="form-control" >
					    </div>
					  </div>
					  <div class="form-group">
					    <label class="col-sm-2 control-label" for="slider_content">Price:</label>
					    <div class="col-sm-5">
