...
<script type="text/javascript">
	$(document).ready(function($) {
		...
		$('#reset').click(function(){
				var base_url = '<?php echo $base_url.'topics/lists'; ?>';
		...
		$(function() {
		$.ajax({
			url:'<?php echo $base_url; ?>topics/ajaxlist_colour',
			type:'POST',
			data:'',
...
<div class="main-content theme">
  <ol class="breadcrumb bc-3">
    ...
    <li class="active"><strong>Topic</strong></li>
  </ol>
<?php if(isset($_POST))
{
if(count($result)==0)
...
{
?>
<a href="<?php echo $base_url;?>topics/lists"></a>
<?php
}
?>
...
<?/*php if(isset($_POST))
{
	...
	{
	?>
	<a class="btn btn-primary add" href="<?php echo $base_url;?>topics/add/"><i class="entypo-plus"></i>Add Topic</a>
	<?php
	}
	else
	{
...
<div class="row">
<div class="col-xs-12 col-sm-12"><h6 class="main-title">List Topic</h6></div>
     <div class="col-6 col-sm-12 col-lg-12 action">
      <div class="end">
        <form action="<?php echo $base_url."topics/lists";?>" method="post" enctype="multipart/form-data" id="form1"  class="pro"  autocomplete="on">
          <div class="form-group mock">
            <label class="col-sm-1 control-label lavel" for="inputEmail">Topic Name :</label>
            <div class="col-lg-3">
           <input type="text" id="topicname" name="topicname"  value="<?php echo $topicname; ?>" class="form-control jobtext from-dainn"   />
            </div>
			<div class="col-lg-5">
			<div class="set1">
...
<?php }  ?>
  ...
  <div role="grid" class="dataTables_wrapper form-inline" id="table-2_wrapper">
    <form action="<?php echo $base_url."topics/deletes";?>" method="post" enctype="multipart/form-data" id="form">
	...
	<table id="table-2" class="table table-bordered table-striped datatable dataTable" aria-describedby="table-2_info" style="float:left;">
        <thead>
			<tr role="row" class="bg">
				...
				<th class="sorting" role="columnheader" aria-controls="table-2" style="width: auto;">Topic Name</th>
        ...
        <tbody role="alert" aria-live="polite" aria-relevant="all">
			...
			<tr class="odd">
				...
				<td class=""><?php echo $result[$i]->topicname; ?></td>
				<td class=""><?php echo $this->topics_model->getusername($result[$i]->userid); ?></td>
				<td class=""><?php echo $result[$i]->added_date; ?></td>
				<td class=""> 
				<a class="btn btn-default btn-sm btn-icon icon-left" title="Edit" href="<?php echo $base_url."topics/list_message/"; ?><?php echo $result[$i]->id; ?>">
					 View Topic 
 				</a></td>
			</tr>
			<?php }  } else { ?>
			<tr>
				<td class="left" colspan="5" align="center"><?php echo 'No Topic Found'; ?></td>
			</tr>
			<?php    }  ?>
        </tbody>
	</table>
