...
<script type="text/javascript">
	$(document).ready(function($) {
		...
		$('#reset').click(function(){
				var base_url = '<?php echo $base_url.'brand/lists'; ?>';
		...
		$(function() {
		$.ajax({
			url:'<?php echo $base_url; ?>brand/ajaxlist_brand',
			type:'POST',
			data:'',
...
{
?>
<a href="<?php echo $base_url;?>brand/lists"></a>
<?php
}
?>
...
<?php if(isset($_POST))
{
	...
	{
	?>
	<a class="btn btn-primary add" href="<?php echo $base_url;?>brand/add/"><i class="entypo-plus"></i>Add Brand</a>
	<?php
	}
	else
	{
...
<div class="row">
<div class="col-xs-12 col-sm-12"><h6 class="main-title">List Brand</h6></div>
     <div class="col-6 col-sm-12 col-lg-12 action">
      <div class="end">
        <form action="<?php echo $base_url."brand/lists";?>" method="post" enctype="multipart/form-data" id="form1"  class="pro"  autocomplete="on">
          <div class="form-group mock">
            <label class="col-sm-1 control-label lavel" for="inputEmail">Brand Name :</label>
            <div class="col-lg-3">
           <input type="text" id="bname" name="bname"  value="<?php echo $bname; ?>" class="form-control jobtext from-dainn"   />
            </div>
			<div class="col-lg-5">
			<div class="set1">
...
<?php }  ?>
  ...
  <div role="grid" class="dataTables_wrapper form-inline" id="table-2_wrapper">
    <form action="<?php echo $base_url."brand/deletes";?>" method="post" enctype="multipart/form-data" id="form">
      ...
      <table id="table-2" class="table table-bordered table-striped datatable dataTable" aria-describedby="table-2_info" style="float:left;">
        ...
        <tbody role="alert" aria-live="polite" aria-relevant="all">
          ...
          <tr class="odd">
           ...
           <td class=""><?php echo $result[$i]->bname; ?></td>
			...
			<td class=" ">
				<a class="btn btn-default btn-sm btn-icon icon-left" title="Edit" href="<?php echo $base_url."brand/edit/"; ?><?php echo $result[$i]->id; ?>">
          ...
          <?php
                  ...
                  ?>
          <tr>
            <td class="left" colspan="3	" align="center"><?php echo 'No Brand Found.!!'; ?></td>
          </tr>
          <?php
                  }
                  ?>
