...
<script type="text/javascript">
	$(document).ready(function($) {
		...
		$('#reset').click(function(){
				var base_url = '<?php echo $base_url.'order/users'; ?>';
...
<div class="main-content theme">
  <ol class="breadcrumb bc-3">
    ...
    <li class="active"><strong>Users Report</strong></li>
  </ol>
...
<div class="row">
<div class="col-xs-12 col-sm-12"><h6 class="main-title"> Users Report 
 <a href="<?php echo $base_url; ?>order/download" style="float:right;color:white;" >Download</a>
     ...
     <div class="col-6 col-sm-12 col-lg-12 action">
      <div class="end">
        <form action="<?php echo $base_url."order/users/";?>" method="post" enctype="multipart/form-data" id="form1"  class="pro"  autocomplete="on">
...
<th class="sorting" role="columnheader" aria-controls="table-2" style="width: auto;">No of Users</th> 
        ...
        <tbody role="alert" aria-live="polite" aria-relevant="all">
		  ...
		  if( isset($_POST['startdate']) && $_POST['startdate'] != '') { 	
		   while(strtotime($startdate) <= strtotime($enddate)){
				...
				$result = $this->order_model->user_manage($startdate, $enddate); 
			?>    
			<tr class="odd">
