...
<div class="col-xs-12 col-sm-12">
  <ol class="breadcrumb bc-3">
		...
		<li class="active"><strong>Edit Return Action Status  <?php  $status; ?></strong></li>
  </ol>
  </div>
  </div>
  ...
  <div class="row">
 	<div class="col-md-12">
 		<div class="panel panel-primary" data-collapsed="0">
			...
			<form class="form-horizontal form-groups-bordered" role="form" id="form" method="post" action="<?php echo $base_url."returnaction/edit/".$id; ?>" enctype="multipart/form-data" >
