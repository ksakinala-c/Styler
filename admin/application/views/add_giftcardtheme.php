...
<div class="main-content">
  <ol class="breadcrumb bc-3">
		...
		<li class="active"><strong>Add Giftcard Theme</strong></li>
  </ol>
 	...
 	<div class="col-md-12">
 		<div class="panel panel-primary" data-collapsed="0">
			...
			Add Giftcard Theme
				...
				<form class="form-horizontal form-groups-bordered" role="form" id="form" name="form" method="post" action="<?php echo $base_url;?>giftcard/add" enctype="multipart/form-data">
				<div class="panel-body">
					<INPUT TYPE="hidden" NAME="hidPgRefRan" VALUE="<?php echo rand();?>">
					<INPUT TYPE="hidden" NAME="action" VALUE="add_giftcardtheme">
