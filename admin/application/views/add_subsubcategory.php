...
<script>
	function validate()
	{
		...
		if(subcatid == '')
		{
			alert('Please select SubsubCategory');
			return false;
		}
...
<div class="col-xs-12 col-sm-12">
  <ol class="breadcrumb bc-3">
		...
		<li class="active"><strong>Add SubSubCategory</strong></li>
  </ol>
  </div>
  </div>
...
<form class="form-horizontal form-groups-bordered" role="form" id="form" method="post" action="<?php echo $base_url;?>subsubcategory/add">
