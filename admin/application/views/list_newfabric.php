...
<script type="text/javascript">
	...
	$(document).ready(function($)
	{
		...
		$('#reset').click(function(){
			...
			var base_url = '<?php echo $base_url.'newfabric/lists/'.$this->uri->segment(3) ?>';
		...
		$.ajax({
			url:'<?php echo $base_url; ?>newfabric/ajaxlist_newfabric',
			type:'POST',
			data:'',
...
<li class="active"><strong>Material</strong></li>
</ol>
<?php if(isset($_POST))
{
if(count($result)==0)
...
{
?>
<a href="<?php echo $base_url;?>newfabric/lists"></a>
<?php
}
?>
<a class="btn btn-third add" href="javascript:void('0');" onclick="deletesize();"><i class="entypo-plus"></i>Delete</a>
<!--a class="btn btn-third add" href="<?php echo $base_url; ?>newfabric/lists"><i class="entypo-plus"></i>Cancel</a-->
<?php if(isset($_POST))
{
if(count($result)==0)
{
?>
<a class="btn btn-primary add" href="<?php echo $base_url;?>newfabric/add/<?php echo $this->uri->segment(3); ?>"><i class="entypo-plus"></i>Add Material</a>
<?php
}
else
{
...
<div role="grid" class="dataTables_wrapper form-inline" id="table-2_wrapper">
 ...
 <div class="col-xs-12 col-sm-12"><h6 class="main-title">List Fabric</h6></div>

    <div class="col-6 col-sm-12 col-lg-12 action">
      <div class="end">
        <form action="<?php echo $base_url."newfabric/lists/".$this->uri->segment(3); ?>" method="post" enctype="multipart/form-data" id="form1"  class="pro">

		<div class="form-group mock">

            <label class="col-lg-1 control-label lavel" for="inputEmail">Material Name:</label>
            <div class="col-lg-3">
            <input type="text" id="fname" name="fname" value="<?php echo $fname;?>" class="form-control jobtext"/>
            </div>
...
<?php }  ?>
  ...
  <div role="grid" class="dataTables_wrapper form-inline" id="table-2_wrapper">
    <form action="<?php echo $base_url."newfabric/deletes/".$this->uri->segment(3)." ";?>" method="post" enctype="multipart/form-data" id="form">
      ...
      <table id="table-2" class="table table-bordered table-striped datatable dataTable" aria-describedby="table-2_info" style="float:left;">
        <thead>
          <tr role="row" class="bg">
            ...
            <!--<th class="sorting" role="columnheader" aria-controls="table-2" style="width: auto;">Id</th>-->	
				<th class="sorting" role="columnheader" aria-controls="table-2" style="width: auto;">Material</th>
        ...
        <tbody role="alert" aria-live="polite" aria-relevant="all">
          ...
          <tr class="odd">
			...
			<td class=" "><?php echo $result[$i]->fname; ?></td> 
			...
			<td class=" ">
				<a class="btn btn-default btn-sm btn-icon icon-left" title="Edit" href="<?php echo $base_url."newfabric/edit/"; ?><?php echo $result[$i]->id; ?>">
