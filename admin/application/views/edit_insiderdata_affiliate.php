...
<div class="col-xs-12 col-sm-12">
  <ol class="breadcrumb bc-3">
		...
		<li class="active"><strong>Edit Affiliate Data</strong></li>
  </ol>
  </div>
  </div>
  ...
  <div class="row">
 	<div class="col-md-12">
 		...
 		<div class="panel panel-primary" data-collapsed="0">
			...
			<form class="form-horizontal form-groups-bordered" enctype="multipart/form-data" role="form" id="form" name="form" method="post" action="<?php echo $base_url;?>affliliate/insider/<?php echo $id; ?>">
		 <div class="panel-body">
		<INPUT TYPE="hidden" NAME="hidPgRefRan" VALUE="<?php echo rand();?>">
		<INPUT TYPE="hidden" NAME="action" id="action" VALUE="edit_insider" >
				 <div class="form-group">
					<label class="col-sm-2 control-label" for="inputEmail">Affiliate Content:</label>  
					<div class="col-sm-5">
				 	  <textarea id="affliliatecontent" name="affliliatecontent" class="form-control"><?php echo $affliliatecontent;?></textarea>
					</div>
				</div>
				
				 <div class="form-group">
					<label class="col-sm-2 control-label" for="inputEmail">Affiliate Percent:</label>  
					<div class="col-sm-5">
				 	  <input type="text" id="affliatepercent" name="affliatepercent" class="form-control" value="<?php echo $affliatepercent;?> ">
					</div>
				</div>
			</div>
		 </form>
  ...
  <script>
	CKEDITOR.replace('affliliatecontent',
	{
