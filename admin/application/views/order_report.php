...
<script type="text/javascript">
	$(document).ready(function($) {
		...
		$('#reset').click(function(){
				var base_url = '<?php echo $base_url.'order/can_order_reports'; ?>';
...
<div class="main-content theme">
  <ol class="breadcrumb bc-3">
    ...
    <li class="active"><strong>Cancel Order Reports</strong></li>
  </ol>
...
<div class="row">
<div class="col-xs-12 col-sm-12"><h6 class="main-title"> Cancel Order Reports </h6></div>
