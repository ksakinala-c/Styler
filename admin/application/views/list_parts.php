...
<script type="text/javascript">
	...
	$(document).ready(function($)
	{
		...
		$('#reset').click(function(){
			...
			var base_url = '<?php echo $base_url.'parts/lists/'.$this->uri->segment(3) ?>';
		...
		$.ajax({
			url:'<?php echo $base_url; ?>parts/ajaxlist_parts',
			type:'POST',
			data:'',
...
<li class="active"><strong>Parts</strong></li>
</ol>
<?php if(isset($_POST))
{
if(count($result)==0)
...
{
?>
<a href="<?php echo $base_url;?>parts/lists"></a>
<?php
}
?>
<a class="btn btn-third add" href="javascript:void('0');" onclick="deleteparts();"><i class="entypo-plus"></i>Delete</a>
<a class="btn btn-third add" href="<?php echo $base_url; ?>subcategory/lists"><i class="entypo-plus"></i>Cancel</a>
<?php if(isset($_POST))
{
if(count($result)==0)
{
?>
<a class="btn btn-primary add" href="<?php echo $base_url;?>parts/add/<?php echo $this->uri->segment(3); ?>"><i class="entypo-plus"></i>Add Parts</a>
<?php
}
else
{
...
<div role="grid" class="dataTables_wrapper form-inline" id="table-2_wrapper">
 ...
 <div class="col-xs-12 col-sm-12"><h6 class="main-title">List Parts</h6></div>

    <div class="col-6 col-sm-12 col-lg-12 action">
      <div class="end">
        <form action="<?php echo $base_url."parts/lists/".$this->uri->segment(3); ?>" method="post" enctype="multipart/form-data" id="form1"  class="pro">

		<div class="form-group mock">

            <label class="col-lg-1 control-label lavel" for="inputEmail">Parts Name:</label>
            <div class="col-lg-3">
            <input type="text" id="pname" name="pname" value="<?php echo $pname;?>" class="form-control jobtext"/>
            </div>
...
<?php }  ?>
  ...
  <div role="grid" class="dataTables_wrapper form-inline" id="table-2_wrapper">
    <form action="<?php echo $base_url."parts/deletes/".$this->uri->segment(3)." ";?>" method="post" enctype="multipart/form-data" id="form">
...
<th class="sorting" role="columnheader" aria-controls="table-2" style="width: auto;">Order</th>			
			<th class="sorting" role="columnheader" aria-controls="table-2" style="width: auto;">Parts Name</th>
        ...
        <tbody role="alert" aria-live="polite" aria-relevant="all">
          ...
          <tr class="odd">
			...
			<td class=" "><?php echo $result[$i]->pname; ?></td> 
			<td class=" "><?php echo $result[$i]->youtubeurl; ?></td> 
			...
			<td class=" ">
			 ...
			 &nbsp; <a class="btn btn-default btn-sm btn-icon icon-left" title="Add Image" href="<?php echo $base_url."parts/editimage/".$result[$i]->id.'/'.$this->uri->segment(3); ?>" >
                     <i>Add Image</i>
                     </a> 
					 
				<a class="btn btn-default btn-sm btn-icon icon-left" title="Edit" href="<?php echo $base_url."parts/edit/"; ?><?php echo $result[$i]->id; ?>/<?php echo $this->uri->segment(3); ?>">
          ...
          <?php
            ...
            ?>
          <tr>
            <td class="left" colspan="4" align="center"> <?php echo 'No Parts Found.'; ?></td>
          </tr>
