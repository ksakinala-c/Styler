...
<script src="<?php echo $base_url_views; ?>js/jscolor.js"></script>
...
<ul class="nav">
		...
		<li>
			...
			||	$this->uri->segment(1) == 'giftcard' && $this->uri->segment(2) == 'lists'
		...
		<!--start brand master -->
			...
			<li>
				<a <?php if($this->uri->segment(1) == 'brand' && $this->uri->segment(2) == 'lists' 
				|| $this->uri->segment(1) == 'fit' && $this->uri->segment(2) == 'lists'
				|| $this->uri->segment(1) == 'bsize' && $this->uri->segment(2) == 'lists')
				{?>class="active"<?php } ?> href="#">Brand Master
 				</a>
				<ul>
					<?php if(in_array('46',$permission1)){ ?>
					<li >
						<a href="<?php echo $base_url;?>brand/lists">Brand</a>	
					</li>
					<?php } ?>
					
					<?php if(in_array('47',$permission1)){ ?>
					<li >
						<a href="<?php echo $base_url;?>fit/lists">Brand-Fit</a>	
					</li>
					<?php } ?>
					
					<?php if(in_array('48',$permission1)){ ?>
					<li >
						<a href="<?php echo $base_url;?>bsize/lists">Brand-Size</a>	
					</li>
					<?php } ?>
		...
		<?php } ?>
			...
			<li>
				...
				$this->uri->segment(1) == 'returnpro' && $this->uri->segment(2) == 'lists'|| 
				$this->uri->segment(1) == 'returnaction' && $this->uri->segment(2) == 'lists'|| 
				$this->uri->segment(1) == 'returnstatus' && $this->uri->segment(2) == 'lists'
		...
		<?php if(in_array('5',$permission1)){ ?>
		<li>
		<a <?php if($this->uri->segment(1) == 'product' && $this->uri->segment(2) == 'order_manage' ){?>
		class="active"<?php } ?>  href="<?php echo $base_url;?>product/order_pending">Abonded Order</a>
		</li>	
		<?php } ?>
				...
				<li>
				<a href="<?php echo $base_url;?>return_product/lists">Return Center</a>
				</li>
				<?php } ?>
				
				<?php if(in_array('49',$permission1)){ ?>
				<li>
				<a href="<?php echo $base_url;?>returnpro/lists">Return Reason Status</a>
				</li>
				<?php } ?>
				
				<?php if(in_array('50',$permission1)){ ?>
				<li>
				<a href="<?php echo $base_url;?>returnaction/lists">Return Action Status</a>
				</li>
				<?php } ?>
				
					<?php if(in_array('51',$permission1)){ ?>
				<li>
				<a href="<?php echo $base_url;?>returnstatus/lists">Return Status</a>
				</li>
				<?php } ?>
		...
		<a <?php if($this->uri->segment(1) == 'cms' && $this->uri->segment(2) == 'lists' || $this->uri->segment(1) == 'banner' && $this->uri->segment(2)=='lists'|| $this->uri->segment(1) == 'popup' && $this->uri->segment(2)=='edit' ){?>class="active"<?php } ?> href="#" class="parent"> CMS
				...
				<?php if(in_array('21',$permission1)){ ?>
					<li>
					<a href="<?php echo $base_url;?>hmpage/settings">Home Page Content</a>
					</li>
				<?php } ?>
				<?php if(in_array('21',$permission1)){ ?>
					<li>
					<a href="<?php echo $base_url;?>hmlistpage/lists">List Page Content</a>
					</li>
				<?php } ?>
		...
		|| $this->uri->segment(1) == 'currency' && $this->uri->segment(2) == 'insider' 
		...
		{?> class="active" <?php } ?> href="#">Systems</a>
			<ul>	
				...
				<li>
					<a href="<?php echo $base_url;?>currency/insider">Currency</a>
				</li>
				<?php } ?>
			</ul>
		...
		<li>
			...
			<?php if(in_array('40',$permission1)){ ?>
				<li>
					<a href="<?php echo $base_url;?>wallet/insider/1">Systems</a>
				</li>
				<?php } ?> 

				
				<?php if(in_array('31',$permission1)){ ?>
					<li><a  href="<?php echo $base_url;?>topics/lists">Topics</a></li>
				<?php } ?> 
				<?php if(in_array('33',$permission1)){ ?>
					<li><a  href="<?php echo $base_url;?>insider_user/lists">User</a></li>
				<?php } ?> 
				<?php if(in_array('34',$permission1)){ ?>
					<li><a  href="<?php echo $base_url;?>insider_message/lists">Message</a></li>
				<?php } ?> 
		...
		<li>
			<a  href="#" <?php 	if($this->uri->segment(1) == 'country' && $this->uri->segment(2) == 'lists'
				|| $this->uri->segment(1) == 'courier' && $this->uri->segment(2) == 'lists'
				|| $this->uri->segment(1) == 'flatrate' && $this->uri->segment(2) == 'edit'
				|| $this->uri->segment(1) == 'weightbase' && $this->uri->segment(2) == 'edit')
			{?> class="active" <?php } ?> >Shipping</a>
			<ul>
		...
		<li>
			<a href="#"  <?php 	if($this->uri->segment(1) == 'affliliate' && $this->uri->segment(2) == 'userlists'
				|| $this->uri->segment(1) == 'affliliate' && $this->uri->segment(2) == 'insider' )
			{?> class="active" <?php } ?> >Affiliate</a>
			<ul>
				<?php if(in_array('44',$permission1)){ ?>
				<li>
					<a href="<?php echo $base_url;?>affliliate/insider/1">Systems</a>
				</li>
				<?php } ?>

				<?php if(in_array('43',$permission1)){ ?>
				<li>
					<a  href="<?php echo $base_url;?>affliliate/userlists">Affiliate Users</a></li>
					<?php } ?> 
				
				<?php if(in_array('42',$permission1)){ ?>
				<li>
				<a href="<?php echo $base_url;?>affliliate/lists">Affiliate Themes</a>
				</li>
				<?php } ?> 
			</ul>
		</li>
		...
		<li>
			<a href="#"  <?php 	if($this->uri->segment(1) == 'coupan' && $this->uri->segment(2) == 'lists_voucher'
				|| $this->uri->segment(1) == 'affliliate' && $this->uri->segment(2) == 'insider' )
			{ ?> class="active" <?php } ?> >Gift Voucher</a>
			<ul>
				<?php if(in_array('39',$permission1)){ ?>
				<li>
				<a href="<?php echo $base_url;?>coupan/lists_voucher">Gift Voucher</a></li>
				<?php } ?>
				
				<?php if(in_array('41',$permission1)){ ?>
				<li>
				<a href="<?php echo $base_url;?>giftcard/lists">Giftcard Themes</a>
				</li>
				<?php } ?>
