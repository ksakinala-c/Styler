...
<script>
		...
		function udpaterecors(val,id,pid,segid){
			...
			if(t)
			{
				var url = '<?php echo $this->config->item("base_url"); ?>parts/updateorder/'+val+'/'+id+'/'+pid+'/'+segid;
				window.location.href=url;
			}
			else
			{
		...
		function setbaseimg(id,pid,segid,image_index)
		{
			...
			if(t)
			{
				var url = '<?php echo $this->config->item("base_url"); ?>parts/setbaseimg/'+id+'/'+pid+'/'+segid+'/'+image_index;
				window.location.href=url;
			}
			else
			{
...
<div class="col-xs-12 col-sm-12">
  <ol class="breadcrumb bc-3">
		...
		<li class="active"><strong>Edit Parts Images - <?php  echo $result->pname; ?></strong></li>
  </ol>
  </div>
  </div>
 			...
 			<div class="panel-heading fill">
				<div class="panel-title">
                    ...
                    <div class="col-6 col-sm-4 col-lg-2 firm">
                      <button class="btn btn-default" onclick="javascript:window.location.href='<?php echo $base_url;?>parts/lists/<?php echo $this->uri->segment(4); ?>'">Cancel</button>
                      <button class="btn btn-scoend" type="submit"  onclick="javascript:validate();return false;">Submit</button>
                      </div>
 				</div>
 			</div>
			<form class="form-horizontal form-groups-bordered" role="form" id="form" method="post" action="<?php echo $base_url;?>parts/editimage/<?php echo $result->id; ?>/<?php echo $this->uri->segment(4); ?>" enctype="multipart/form-data" >
			...
			<table>
				...
				<tr>
					<td colspan="2">
							...
							&nbsp;&nbsp;&nbsp;
							<img src="<?php echo $this->config->item('front_base_url')."upload/parts/small/".$images->image; ?>" />
							&nbsp;&nbsp;&nbsp;
							...
							<a onclick="removeimage('<?php echo $this->config->item('base_url')."parts/removeimage/".$images->id."/".$images->pid ."/".$this->uri->segment(4);?>');"
							href="#">Remove</a>
