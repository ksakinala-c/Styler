  ...
  <div class="row">
 	<div class="col-md-12">
 		<div class="panel panel-primary" data-collapsed="0">
			...
			<form class="form-horizontal form-groups-bordered" role="form" id="form"  method="post" action="<?php echo $base_url;?>bsize/add" enctype="multipart/form-data">
 			<div class="panel-body">
				
					<INPUT TYPE="hidden" NAME="hidPgRefRan" VALUE="<?php echo rand();?>">
					<INPUT TYPE="hidden" NAME="action" VALUE="add_bsize">
						...
						<span id="prod1">
						  <select id="fitid" name="fitid" class="form-control" >
								...
								{ foreach($allfit as $fit) { ?>
										<option value="<?php echo $fit->id; ?>"><?php echo $fit->fitname; ?></option>
								<?php  } }	 ?>
						   </select>
						   </span>
					</div>
