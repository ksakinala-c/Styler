...
<table id="table-2" class="table table-bordered table-striped datatable dataTable" aria-describedby="table-2_info">
	<thead>
		<tr role="row" class="bg">
			...
			<th class="sorting" role="columnheader" aria-controls="table-2" style="width: auto;">Appointment Location</th>
	...
	<tbody role="alert" aria-live="polite" aria-relevant="all">
		...
		<tr class="odd">
			...
			<td class=" "><?php echo $result[$i]->appointment_date; ?></td>
			<td class=" "><?php echo $hoursRange[$result[$i]->start_time]; ?></td>
 			<td class=" "><?php echo $result[$i]->appointment_location; ?></td>
 			<?php
