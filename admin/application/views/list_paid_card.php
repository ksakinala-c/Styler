...
<script type="text/javascript">
	$(document).ready(function($) {
		...
		$('#reset').click(function(){
				var base_url = '<?php echo $base_url.'coupan/paid_card'; ?>';
...
<div class="row">
<div class="col-xs-12 col-sm-12"><h6 class="main-title">Paid Gift Card 
<?php /* if($value!=''){
	$value=$value;
}else{
	$value='null';
...
*/ ?>
     ...
     <div class="col-6 col-sm-12 col-lg-12 action">
      <div class="end">
        <form action="<?php echo $base_url."coupan/paid_card";?>" method="post" enctype="multipart/form-data" id="form1"  class="pro"  autocomplete="on">
  ...
  <div role="grid" class="dataTables_wrapper form-inline" id="table-2_wrapper">
	...
	<table id="table-2" class="table table-bordered table-striped datatable dataTable" aria-describedby="table-2_info" style="float:left;">
        ...
        <tbody role="alert" aria-live="polite" aria-relevant="all">
			...
			<?php }  } else { ?>
			<tr>
				<td class="left" colspan="8" align="center"><?php echo 'No Paid Gift Card Found.!!'; ?></td>
			</tr>
			<?php    }  ?>
        </tbody>
	</table>
