<?php
	...
	}	function add($content) 	{		$L_strErrorMessage='';		$data['coupanname'] = $content['coupanname'];		$data['discount'] = $content['discount'];		$data['price'] = $content['price'];		$data['percentage'] = $content['percentage'];		$data['description'] = $content['description'];		$data['startdate'] = $content['startdate'];		$data['enddate'] = $content['enddate'];				$this->_data = $data;		if ($this->db->insert('tbl_coupan', $this->_data))			{							return true;			 		} 		else 		{			return false;		}	}
